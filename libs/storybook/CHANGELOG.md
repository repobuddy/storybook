...
- [#775](https://github.com/repobuddy/storybook/pull/775) [`ec459fc`](https://github.com/repobuddy/storybook/commit/ec459fcba98fe51de0badb0e08f63077979b2a1d) Thanks [@unional](https://github.com/unional)! - Pin `type-plus` to the exact version `8.0.0-beta.10`.
...
- [#752](https://github.com/repobuddy/storybook/pull/752) [`b518cc4`](https://github.com/repobuddy/storybook/commit/b518cc4b17a80f53175dcf57483446fb95bfc25c) Thanks [@unional](https://github.com/unional)! - Depend on `type-plus` as a range on the 8.x line, `^8.0.0-beta.10`, instead of the stable `^7.6.2`.
...
- [#742](https://github.com/repobuddy/storybook/pull/742) [`29d73d0`](https://github.com/repobuddy/storybook/commit/29d73d092f0ca509e652274aad93fc29bd3e6bf3) Thanks [@unional](https://github.com/unional)! - Depend on the stable `type-plus@^7.6.2` instead of the prerelease `type-plus@8.0.0-beta.8`.
