import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t}from"./chunk-W22LQPXL-B066xLLY.js";import{_ as n,a as r}from"./theming-BPuu_FHA.js";import{n as i,r as a}from"./iframe-DurS4ax6.js";import{n as o,t as s}from"./dedent-DQaCLeUO.js";import{M as c,O as l,_ as u,j as d,t as f,w as p}from"./src-Cjk9gBKT.js";var m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V;function H(){return(H=e((()=>{o(),r(),d(),f(),i(),m=t(),{expect:h}=__STORYBOOK_MODULE_TEST__,g=({text:e=`Hello World`})=>(0,m.jsx)(`div`,{className:`rbsb:p-4 rbsb:text-black rbsb:dark:text-white rbsb:bg-gray-100 rbsb:dark:bg-gray-500 rbsb:rounded`,children:e}),_=a.meta({title:`decorators/showSource`,tags:[`version:2.22`,`!snapshot`],render:()=>(0,m.jsx)(m.Fragment,{})}),v=_.story({name:`Show docs.source.code`,tags:[`use-case`],parameters:{docs:{source:{code:`() => /* from docs.source.code */ <DemoComponent text="Hello World" />`}}},decorators:[p({content:(0,m.jsxs)(`p`,{children:[`When `,(0,m.jsx)(`code`,{children:`docs.source.code`}),` is provided, the decorator will show it by default.`]})}),l({source:s`{
