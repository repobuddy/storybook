import{n as e}from"./chunk-DnJy8xQt.js";import{t}from"./jsx-runtime-DC6t-S6Q.js";import{g as n,i as r,m as i,v as a}from"./iframe-BsHda9nq.js";import{n as o,t as s}from"./dedent-DU6uki2e.js";var c,l,u,d,f,p,m,h;e((()=>{o(),r(),c=t(),{fn:l}=__STORYBOOK_MODULE_TEST__,u={title:`Parameters/defineActionsParam`,tags:[`func`,`!snapshot`,`new`,`version:1.0`],decorators:[a()],args:{onClick:l()},render:()=>(0,c.jsx)(c.Fragment,{})},d={parameters:{...n({argTypesRegex:`^on[A-Z].*`}),...i({source:{code:s`defineActionsParam({
                    argTypesRegex: '^on[A-Z].*'
                })`}})}},f={parameters:{...n({disable:!0}),...i({source:{code:s`defineActionsParam({
                    disable: true
                })`}})}},p={parameters:{...n({handles:[`onClick`,`onMouseOver`,`onSubmit`]}),...i({source:{code:s`defineActionsParam({
                    handles: ['onClick', 'onMouseOver', 'onSubmit']
                })`}})}},m={parameters:{...n({argTypesRegex:`^on[A-Z].*`,handles:[`customEvent`,`anotherEvent`],disable:!1}),...i({source:{code:s`defineActionsParam({
                argTypesRegex: '^on[A-Z].*',
