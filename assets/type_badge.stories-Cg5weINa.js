import{j as o}from"./iframe-BFuxzFTn.js";import{d as t}from"./dedent-BuYMbVyj.js";import"./show_source-Dp2YpilM.js";import{s}from"./show_doc_source-CrRgjBUB.js";import{w as a}from"./with_story_card-B4w4FguD.js";import"./preload-helper-PPVm8Dsz.js";const y={title:"storybook-addon-tag-badges/typeBadge",tags:["var","!snapshot","version:2.15"],render:()=>o.jsx(o.Fragment,{})},e={tags:["type"],decorators:[a({content:o.jsxs("p",{children:["Story that showcases or documents TypeScript types. In the sidebar it appears as ",o.jsx("code",{children:"<T>"}),"."]})}),s({source:t`export const YourStory = {
                tags: ['type'],
