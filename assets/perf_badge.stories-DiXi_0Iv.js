import{j as e}from"./iframe-CTjeFRQZ.js";import{d as t}from"./dedent-BuYMbVyj.js";import"./show_source-DR4gBb21.js";import{s as r}from"./show_doc_source-D9JsOhvH.js";import{w as n}from"./with_story_card-DxjhZ72i.js";import"./preload-helper-PPVm8Dsz.js";const f={title:"storybook-addon-tag-badges/perfBadge",tags:["var","!snapshot","version:2.22"],render:()=>e.jsx(e.Fragment,{})},o={tags:["perf"],decorators:[n({content:e.jsx(e.Fragment,{children:e.jsxs("p",{children:["Story that demonstrates or tests performance. In the sidebar it appears as ",e.jsx("code",{children:"⚡"}),"."]})})}),r({placement:"before",source:t`export const YourStory = {
                tags: ['perf'],
...
}`,...o.parameters?.docs?.source}}};const m=["PerfBadge"];export{o as PerfBadge,m as __namedExportsOrder,f as default};
