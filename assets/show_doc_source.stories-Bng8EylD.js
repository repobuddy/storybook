import{j as o,t as m}from"./iframe-CPGXPhzn.js";import{s as e,w as u}from"./with_story_card-CbFTZXUp.js";import{d as t}from"./define_docs_param-lmgaBKCF.js";import"./preload-helper-PPVm8Dsz.js";const i=({text:d="Hello World"})=>o.jsx("div",{className:"p-4 bg-gray-100 dark:bg-gray-500 rounded",children:d}),S={title:"decorators/showDocSource",tags:["version:next"],render:()=>o.jsx(o.Fragment,{})},r={decorators:[e()],render:()=>o.jsx(i,{text:"Hello World"})},s={name:"Show docs.source.code",parameters:{docs:{source:{code:'() => <DemoComponent text="Hello World" />'}}},decorators:[u({content:o.jsxs("p",{children:["Shows the code in ",o.jsx("code",{children:"docs.source.code"})," parameter"]})}),e(),e({showOriginalSource:!0})]},a={name:"With docs.source.language: json",parameters:t({source:{code:'{ "hello": "world" }',language:"json"}}),decorators:[e(),e({showOriginalSource:!0})]},c={name:"With docs.source.language: md",parameters:t({source:{code:"This is a `markdown` text",language:"md"}}),decorators:[e(),e({showOriginalSource:!0})]},n={name:"With docs.theme: dark",parameters:t({source:{code:"<div>Hello, World!</div>"},theme:m.dark}),decorators:[e(),e({showOriginalSource:!0})]};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
