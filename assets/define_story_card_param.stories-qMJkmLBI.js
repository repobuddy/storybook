import{j as t}from"./iframe-LNk-wMqE.js";import{w as e,s as b}from"./with_story_card-BPnILLEQ.js";import{d as r}from"./define_docs_param-lmgaBKCF.js";import{d as s}from"./dedent-BuYMbVyj.js";import"./preload-helper-PPVm8Dsz.js";function a(m){return{storyCard:m}}const T={title:"parameters/defineStoryCard",tags:["new","version:2.9"],decorators:[b()],render:()=>t.jsx("p",{children:"This is the story content"})},o={parameters:{...a({title:"Important Notice",status:"info",content:t.jsx("p",{children:"This is a custom message displayed in the card."})}),...r({source:{code:s`defineStoryCard({
                    title: 'Important Notice',
                    status: 'info',
                    content: <p>This is a custom message displayed in the card.</p>
                })`}})},decorators:[e()]},n={parameters:{...r({description:{story:"This description will be automatically shown in the card."}}),...a({title:"Story Information",status:"info"}),...r({source:{code:s`defineStoryCard({
                ...
                })`}})},decorators:[e({title:"Decorator Title",status:"warn",content:t.jsx("p",{children:"This content comes from the decorator and overrides the parameter values."})})]};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  parameters: {
    ...defineStoryCard({
      title: 'Important Notice',
      status: 'info',
