import{j as t}from"./iframe-B11Pj9s8.js";import{d as s}from"./dedent-BuYMbVyj.js";import{s as r}from"./show_doc_source-BXcntEzR.js";import{w as e}from"./with_story_card-DwCcQ4VZ.js";import"./preload-helper-PPVm8Dsz.js";const i={title:"storybook-addon-tag-badges/snapshotBadge",tags:["var","!test","version:0.7"],render:()=>t.jsx(t.Fragment,{})},o={tags:["snapshot"],decorators:[e({content:t.jsxs("p",{children:["Story with snapshot test. It appears as ",t.jsx("code",{children:"📸"})," in the toolbar (not in the sidebar)."]})}),r({source:s`export const YourStory = {
                tags: ['snapshot'],
