import{j as e}from"./iframe-C9kpuA6j.js";import{d as t}from"./dedent-BuYMbVyj.js";import{s as r}from"./show_source-CT_A95FG.js";import{w as n}from"./with_story_card-Cel-eGqc.js";import"./preload-helper-PPVm8Dsz.js";const p={title:"storybook-addon-tag-badges/perfBadge",tags:["var","!snapshot","version:2.22"],render:()=>e.jsx(e.Fragment,{})},o={tags:["perf"],decorators:[n({content:e.jsx(e.Fragment,{children:e.jsxs("p",{children:["Story that demonstrates or tests performance. In the sidebar it appears as ",e.jsx("code",{children:"⚡"}),"."]})})}),r({placement:"before",source:t`export const YourStory = {
                tags: ['perf'],
