import{j as o,t as b}from"./iframe-CiKgtrI_.js";import{s as e,w as g}from"./with_story_card-DrabSA8G.js";import{d as r}from"./define_docs_param-lmgaBKCF.js";import"./preload-helper-PPVm8Dsz.js";const m=({text:s="Hello World"})=>o.jsx("div",{className:"rbsb:p-4 rbsb:bg-gray-100 rbsb:dark:bg-gray-500 rbsb:rounded",children:s}),W={title:"decorators/showDocSource",tags:["version:2.4"],render:()=>o.jsx(o.Fragment,{})},a={decorators:[e()],render:()=>o.jsx(m,{text:"Hello World"})},n={name:"Show docs.source.code",parameters:{docs:{source:{code:'() => <DemoComponent text="Hello World" />'}}},decorators:[g({content:o.jsxs("p",{children:["Shows the code in ",o.jsx("code",{children:"docs.source.code"})," parameter"]})}),e(),e({showOriginalSource:!0})]},t={name:"With docs.source.language: json",parameters:r({source:{code:'{ "hello": "world" }',language:"json"}}),decorators:[e(),e({showOriginalSource:!0})]},c={name:"With docs.source.language: md",parameters:r({source:{code:"This is a `markdown` text",language:"md"}}),decorators:[e(),e({showOriginalSource:!0})]},d={name:"With docs.theme: dark",parameters:r({source:{code:"<div>Hello, World!</div>"},theme:b.dark}),decorators:[e(),e({showOriginalSource:!0})]},i={name:"className: string",tags:["props","version:next"],parameters:r({source:{code:"<div>Hello, World!</div>"},description:{story:"Demonstrates using className as a string to add custom styling"}}),decorators:[e({showOriginalSource:!0,className:"rbsb:bg-blue-500 rbsb:dark:bg-blue-900"})],render:()=>o.jsx(m,{text:"Custom border and shadow"})},l={name:"className: function",tags:["props","version:next"],parameters:r({source:{code:"<div>Hello, World!</div>"},description:{story:"Demonstrates using className as a function to conditionally apply styles based on state"}}),decorators:[e({className:({defaultClassName:s})=>`${s} rbsb:border-2 rbsb:border-purple-500 rbsb:rounded-lg`})],render:()=>o.jsx(m,{text:"Function-based styling"})},u={name:"With className: conditional function",tags:["props","version:next"],parameters:r({source:{code:"<div>Hello, World!</div>"},description:{story:"Demonstrates using className function to access state and apply conditional styles"}}),decorators:[e({className:({defaultClassName:s,status:p})=>`${s} ${p==="info"?"rbsb:border-2 rbsb:border-blue-500 rbsb:ring-2 rbsb:ring-blue-200 rbsb:dark:ring-blue-800":"rbsb:border-2 rbsb:rounded-lg"}`})],render:()=>o.jsx(m,{text:"Conditional styling with function"})};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
