import{n as e}from"./chunk-DnJy8xQt.js";import{t}from"./jsx-runtime-DC6t-S6Q.js";import{_ as n,d as r,i,m as a,v as o}from"./iframe-BsHda9nq.js";import{n as s,t as c}from"./dedent-DU6uki2e.js";var l,u,d,f,p,m,h,g,_,v,y;e((()=>{s(),i(),l=t(),u={title:`parameters/defineStoryCard`,tags:[`func`,`new`,`version:2.9`],decorators:[o()],render:()=>(0,l.jsx)(`p`,{children:`This is the story content`})},d={parameters:{...r({title:`Important Notice`,status:`info`,content:(0,l.jsx)(`p`,{children:`This is a custom message displayed in the card.`})}),...a({source:{code:c`defineStoryCard({
                    title: 'Important Notice',
                    status: 'info',
                    content: <p>This is a custom message displayed in the card.</p>
                })`}})},decorators:[n()]},f={parameters:{...a({description:{story:`This description will be automatically shown in the card.`}}),...r({title:`Story Information`,status:`info`}),...a({source:{code:c`defineStoryCard({
                    title: 'Story Information',
                    status: 'info'
                })`}})},decorators:[n()]},p={parameters:{...r({title:`Error Card`,status:`error`,content:(0,l.jsx)(`p`,{children:`This card displays an error status with red background styling.`})}),...a({source:{code:c`defineStoryCard({
                    title: 'Error Card',
                    status: 'error',
                    content: <p>This card displays an error status with red background styling.</p>
                })`}})},decorators:[n()]},m={parameters:{...r({title:`Warning Card`,status:`warn`,content:(0,l.jsx)(`p`,{children:`This card displays a warning status with yellow background styling.`})}),...a({source:{code:c`defineStoryCard({
                    title: 'Warning Card',
                    status: 'warn',
                    content: <p>This card displays a warning status with yellow background styling.</p>
                })`}})},decorators:[n()]},h={parameters:{...r({title:`Info Card`,status:`info`,content:(0,l.jsx)(`p`,{children:`This card displays an info status with blue background styling. This is the default status.`})}),...a({source:{code:c`defineStoryCard({
                    title: 'Info Card',
                    status: 'info',
                    content: <p>This card displays an info status with blue background styling. This is the default status.</p>
                })`}})},decorators:[n()]},g={parameters:{...r({title:`Custom Styled Card`,status:`info`,content:(0,l.jsx)(`p`,{children:`This card has custom border styling applied via className.`}),className:`rbsb:border-2 rbsb:border-blue-500 rbsb:shadow-lg`}),...a({source:{code:c`defineStoryCard({
                ...
                })`}})},decorators:[n()]},_={parameters:{...r({title:`Function-Based Styling`,status:`info`,content:(0,l.jsx)(`p`,{children:`This card uses a function to compute className based on the card state.`}),className:({status:e,defaultClassName:t})=>`${t} rbsb:border-2 ${e===`info`?`rbsb:border-green-500`:e===`warn`?`rbsb:border-yellow-500`:`rbsb:border-red-500`} rbsb:shadow-lg`}),...a({source:{code:c`defineStoryCard({
                ...
                })`}})},decorators:[n()]},v={parameters:{...r({title:`Parameter Title`,status:`info`,content:(0,l.jsx)(`p`,{children:`This content will be overridden by the decorator.`})}),...a({source:{code:c`// Parameters define default values
                defineStoryCard({
                ...
                })`}})},decorators:[n({title:`Decorator Title`,status:`warn`,content:(0,l.jsx)(`p`,{children:`This content comes from the decorator and overrides the parameter values.`})})]},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  parameters: {
