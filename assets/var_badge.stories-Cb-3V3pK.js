import{j as r}from"./iframe-B4Fl_E7C.js";import{d as o}from"./dedent-BuYMbVyj.js";import{s as t}from"./show_source-D_hPi-DF.js";import{w as s}from"./with_story_card-4VxCvVhT.js";import"./preload-helper-PPVm8Dsz.js";const p={title:"storybook-addon-tag-badges/varBadge",tags:["var","!snapshot","version:2.16"],render:()=>r.jsx(r.Fragment,{})},e={name:"Variable Badge",tags:["var"],decorators:[s({content:r.jsxs("p",{children:["Story that describes values and variables. In the sidebar it appears as ",r.jsx("code",{children:"var"}),"."]})}),t({source:o`export default {
                tags: ['var'],
                // ...
            } satisfies Meta
