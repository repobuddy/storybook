import{j as e}from"./iframe-BJ-riZOY.js";import{d as n}from"./dedent-BuYMbVyj.js";import"./show_source-DxRl531K.js";import{s as r}from"./show_doc_source-BDlDdvfH.js";import{w as t}from"./with_story_card-DSl7Nptl.js";import"./preload-helper-PPVm8Dsz.js";const m={title:"storybook-addon-tag-badges/codeOnlyBadge",tags:["var","!snapshot","version:0.11"],render:()=>e.jsx(e.Fragment,{})},o={tags:["code-only"],decorators:[t({content:e.jsxs("p",{children:["Components that only exist in code, and not in design. In the sidebar it appears as ",e.jsx("code",{children:"📝"}),"."]})}),r({source:n`export const YourStory = {
                tags: ['code-only'],
