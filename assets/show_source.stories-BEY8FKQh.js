import{n as e}from"./chunk-BneVvdWh.js";import{c as t,x as n}from"./theming-DSY-Eod2.js";import{t as r}from"./jsx-runtime-6sF1Ejqi.js";import{n as i,t as a}from"./dedent-r2SG9fgm.js";import{d as o,g as s,m as c,t as l,v as u,y as d}from"./src-B1BCb3C2.js";var f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N;e((()=>{i(),t(),u(),l(),f=r(),{expect:p}=__STORYBOOK_MODULE_TEST__,m=({text:e=`Hello World`})=>(0,f.jsx)(`div`,{className:`rbsb:p-4 rbsb:bg-gray-100 rbsb:dark:bg-gray-500 rbsb:rounded`,children:e}),h={title:`decorators/showSource`,tags:[`version:2.22`,`!snapshot`],render:()=>(0,f.jsx)(f.Fragment,{})},g={name:`Show docs.source.code`,tags:[`use-case`],parameters:{docs:{source:{code:`() => /* from docs.source.code */ <DemoComponent text="Hello World" />`}}},decorators:[c({content:(0,f.jsxs)(`p`,{children:[`When `,(0,f.jsx)(`code`,{children:`docs.source.code`}),` is provided, the decorator will show it by default.`]})}),s({source:a`{
