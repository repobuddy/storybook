import{j as e}from"./iframe-C9kpuA6j.js";import{d as t}from"./dedent-BuYMbVyj.js";import{s}from"./show_source-CT_A95FG.js";import{w as a}from"./with_story_card-Cel-eGqc.js";import"./preload-helper-PPVm8Dsz.js";const m={title:"storybook-addon-tag-badges/typeBadge",tags:["var","!snapshot","version:2.15"],render:()=>e.jsx(e.Fragment,{})},o={tags:["type"],decorators:[a({content:e.jsxs("p",{children:["Story that showcases or documents TypeScript types. In the sidebar it appears as ",e.jsx("code",{children:"<T>"}),"."]})}),s({source:t`export const YourStory = {
                tags: ['type'],
