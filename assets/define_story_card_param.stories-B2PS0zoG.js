import{j as r}from"./iframe-5VV-1lks.js";import{d as e}from"./dedent-BuYMbVyj.js";import{s as b}from"./show_doc_source-BdGfzFOy.js";import{w as s}from"./with_story_card-CC35l5cY.js";import{d as t}from"./define_docs_param-lmgaBKCF.js";import"./preload-helper-PPVm8Dsz.js";function a(m){return{storyCard:m}}const N={title:"parameters/defineStoryCard",tags:["func","new","version:2.9"],decorators:[b()],render:()=>r.jsx("p",{children:"This is the story content"})},o={parameters:{...a({title:"Important Notice",status:"info",content:r.jsx("p",{children:"This is a custom message displayed in the card."})}),...t({source:{code:e`defineStoryCard({
