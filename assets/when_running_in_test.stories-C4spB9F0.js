import{n as e}from"./chunk-DnJy8xQt.js";import{t}from"./jsx-runtime-DC6t-S6Q.js";import{E as n,T as r,c as i,i as a,o,s,v as c}from"./iframe-BsHda9nq.js";var l=e((()=>{r()})),u,d,f,p,m,h,g;e((()=>{l(),a(),i(),u=t(),{expect:d}=__STORYBOOK_MODULE_TEST__,f={title:`testing/whenRunningInTest`,tags:[`new`,`version:1.0`],beforeEach:()=>{s.isRunningInTest=()=>!0},decorators:[c()],render:()=>(0,u.jsx)(u.Fragment,{}),afterEach:()=>{s.isRunningInTest=n}},p={decorators:[o(e=>(0,u.jsxs)(`div`,{children:[(0,u.jsx)(`div`,{children:`Decorator will be attached when running in test`}),(0,u.jsx)(e,{})]}))]},m={loaders:[()=>({state:{counter:0}})],decorators:[o((e,{loaded:{state:t}})=>{t.counter=1})],render:()=>(0,u.jsx)(`div`,{children:`When passing in a handler (which returns nothing), the story will be rendered`}),play:async e=>{let{canvas:t,loaded:{state:n}}=e;await d(n.counter).toBe(1),await d(t.getByText(/When passing in a handler/)).toBeInTheDocument()}},h={tags:[`unit`],beforeEach:()=>{s.isRunningInTest=()=>!1},decorators:[o(()=>{throw Error(`should not run`)})],render:()=>(0,u.jsx)(u.Fragment,{children:`should not run decorator when not in test`})},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
