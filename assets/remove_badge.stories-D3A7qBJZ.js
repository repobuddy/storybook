import{j as e}from"./iframe-DV8jNMLG.js";import{d as n}from"./dedent-BuYMbVyj.js";import{s}from"./show_doc_source-Cb5n2CSh.js";import{w as a}from"./with_story_card-BFGAN5gi.js";import"./preload-helper-PPVm8Dsz.js";const u={title:"storybook-addon-tag-badges/removeBadge",tags:["var","!snapshot","version:2.19"],render:()=>e.jsx(e.Fragment,{})},t={tags:["remove:2"],decorators:[a({content:e.jsxs("p",{children:["Feature or component scheduled for removal in version 2.0.0. In the sidebar it appears as ",e.jsx("code",{children:"☠️v2"}),"."]})}),s({source:n`export const YourStory = {
                tags: ['remove:2'],
