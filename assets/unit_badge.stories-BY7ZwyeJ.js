import{j as r}from"./iframe-B11Pj9s8.js";import{d as o}from"./dedent-BuYMbVyj.js";import{s as e}from"./show_doc_source-BXcntEzR.js";import{w as s}from"./with_story_card-DwCcQ4VZ.js";import"./preload-helper-PPVm8Dsz.js";const p={title:"storybook-addon-tag-badges/unitBadge",tags:["var","version:0.11"],render:()=>r.jsx(r.Fragment,{})},t={tags:["unit"],decorators:[s({content:r.jsxs("p",{children:["Unit test story. In the sidebar it appears as ",r.jsx("code",{children:"🧪"}),"."]})}),e({source:o`export const YourStory = {
                tags: ['unit'],
