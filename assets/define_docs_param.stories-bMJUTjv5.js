import{j as c}from"./iframe-DqDZFIl0.js";import{s as n}from"./with_story_card-B6VU7sTN.js";import{d as s}from"./define_docs_param-lmgaBKCF.js";import{d as t}from"./dedent-BuYMbVyj.js";import"./preload-helper-PPVm8Dsz.js";const u={title:"Parameters/defineDocsParam",tags:["autodocs","new","version:1.0"],parameters:s({description:{component:"`docs.description.component` can be used to describe the component in meta. It has no effect on the stories."}}),decorators:[n()],render:()=>c.jsx(c.Fragment,{})},e={parameters:s({source:{code:t`
            /**
