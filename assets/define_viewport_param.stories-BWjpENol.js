import{j as s}from"./iframe-5VV-1lks.js";import{d as o}from"./dedent-BuYMbVyj.js";import{s as d}from"./show_doc_source-BdGfzFOy.js";import{d as n}from"./define_docs_param-lmgaBKCF.js";import"./preload-helper-PPVm8Dsz.js";function i(p){return{viewport:p}}const f={title:"Parameters/defineViewportParam",tags:["autodocs","func","new","version:1.0"],decorators:[d()],render:()=>s.jsx(s.Fragment,{})},e={parameters:{...i({defaultViewport:"mobile1",viewports:{mobile1:{name:"Mobile",styles:{width:"320px",height:"568px"},type:"mobile"},tablet1:{name:"Tablet",styles:{width:"768px",height:"1024px"},type:"tablet"}}}),...n({source:{code:o`defineViewportParam({
