import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t}from"./chunk-W22LQPXL-B066xLLY.js";import{n,r}from"./iframe-B3mkwjL8.js";import{n as i,t as a}from"./dedent-DQaCLeUO.js";import{O as o,_ as s,t as c,x as l}from"./src-Cjk9gBKT.js";var u,d,f,p,m,h,g,_;function v(){return(v=e((()=>{i(),c(),n(),u=t(),{fn:d}=__STORYBOOK_MODULE_TEST__,f=r.meta({title:`Parameters/defineActionsParam`,tags:[`func`,`!snapshot`,`new`,`version:1.0`],decorators:[o()],args:{onClick:d()},render:()=>(0,u.jsx)(u.Fragment,{})}),p=f.story({parameters:{...l({argTypesRegex:`^on[A-Z].*`}),...s({source:{code:a`defineActionsParam({
                ...
                disable: false
            })`}})}}),_=[`WithArgTypesRegex`,`DisabledActions`,`ExplicitHandles`,`CombinedConfig`],p.input.parameters={...p.input.parameters,docs:{...p.input.parameters?.docs,source:{originalSource:`meta.story({
  parameters: {
    ...defineActionsParam({
      argTypesRegex: '^on[A-Z].*'
    }),
...
})`,...g.input.parameters?.docs?.source},description:{story:`Example showing combined configuration options`,...g.input.parameters?.docs?.description}}}})))()}v();export{g as CombinedConfig,m as DisabledActions,h as ExplicitHandles,p as WithArgTypesRegex,_ as __namedExportsOrder};