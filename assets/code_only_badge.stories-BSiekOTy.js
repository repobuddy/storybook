import{j as e}from"./iframe-BFuxzFTn.js";import{d as n}from"./dedent-BuYMbVyj.js";import"./show_source-Dp2YpilM.js";import{s as r}from"./show_doc_source-CrRgjBUB.js";import{w as t}from"./with_story_card-B4w4FguD.js";import"./preload-helper-PPVm8Dsz.js";const m={title:"storybook-addon-tag-badges/codeOnlyBadge",tags:["var","!snapshot","version:0.11"],render:()=>e.jsx(e.Fragment,{})},o={tags:["code-only"],decorators:[t({content:e.jsxs("p",{children:["Components that only exist in code, and not in design. In the sidebar it appears as ",e.jsx("code",{children:"📝"}),"."]})}),r({source:n`export const YourStory = {
                tags: ['code-only'],
