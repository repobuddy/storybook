import{j as i}from"./iframe-OSi_oQTO.js";import{d as a}from"./dedent-BuYMbVyj.js";import{s as d}from"./show_doc_source-C1NzTEQH.js";import{d as o}from"./define_docs_param-lmgaBKCF.js";import"./preload-helper-PPVm8Dsz.js";function t(c){return{actions:c}}const{fn:m}=__STORYBOOK_MODULE_TEST__,h={title:"Parameters/defineActionsParam",tags:["new","version:1.0"],decorators:[d()],args:{onClick:m()},render:()=>i.jsx(i.Fragment,{})},e={parameters:{...t({argTypesRegex:"^on[A-Z].*"}),...o({source:{code:a`defineActionsParam({
