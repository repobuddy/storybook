import{j as r}from"./iframe-EXfgSe8t.js";import{d as e}from"./dedent-BuYMbVyj.js";import{w as s,s as b}from"./with_story_card-Rxr-9I5r.js";import{d as t}from"./define_docs_param-lmgaBKCF.js";import"./preload-helper-PPVm8Dsz.js";function a(m){return{storyCard:m}}const T={title:"parameters/defineStoryCard",tags:["new","version:2.9"],decorators:[b()],render:()=>r.jsx("p",{children:"This is the story content"})},o={parameters:{...a({title:"Important Notice",status:"info",content:r.jsx("p",{children:"This is a custom message displayed in the card."})}),...t({source:{code:e`defineStoryCard({
