import{j as c}from"./iframe-B11Pj9s8.js";import{d as t}from"./dedent-BuYMbVyj.js";import{s as n}from"./show_doc_source-BXcntEzR.js";import{d as s}from"./define_docs_param-lmgaBKCF.js";import"./preload-helper-PPVm8Dsz.js";const u={title:"Parameters/defineDocsParam",tags:["autodocs","func","new","version:1.0"],parameters:s({description:{component:"`docs.description.component` can be used to describe the component in meta. It has no effect on the stories."}}),decorators:[n()],render:()=>c.jsx(c.Fragment,{})},e={parameters:s({source:{code:t`
            /**
