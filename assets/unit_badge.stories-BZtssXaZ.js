import{j as r}from"./iframe-C9kpuA6j.js";import{d as e}from"./dedent-BuYMbVyj.js";import{s as o}from"./show_source-CT_A95FG.js";import{w as s}from"./with_story_card-Cel-eGqc.js";import"./preload-helper-PPVm8Dsz.js";const p={title:"storybook-addon-tag-badges/unitBadge",tags:["var","!snapshot","version:0.11"],render:()=>r.jsx(r.Fragment,{})},t={tags:["unit"],decorators:[s({content:r.jsxs("p",{children:["Unit test story. In the sidebar it appears as ",r.jsx("code",{children:"🧪"}),"."]})}),o({source:e`export const YourStory = {
                tags: ['unit'],
