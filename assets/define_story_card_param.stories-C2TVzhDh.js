import{j as r}from"./iframe-CgJZ0YZZ.js";import{d as e}from"./dedent-BuYMbVyj.js";import{s as b}from"./show_doc_source-DUPdG6VB.js";import{w as s}from"./with_story_card-BnfzPkHd.js";import{d as t}from"./define_docs_param-lmgaBKCF.js";import{d as a}from"./define_story_card_param-CqwrtaqB.js";import"./preload-helper-PPVm8Dsz.js";const P={title:"parameters/defineStoryCard",tags:["func","new","version:2.9"],decorators:[b()],render:()=>r.jsx("p",{children:"This is the story content"})},o={parameters:{...a({title:"Important Notice",status:"info",content:r.jsx("p",{children:"This is a custom message displayed in the card."})}),...t({source:{code:e`defineStoryCard({
...
}`,...u.parameters?.docs?.source},description:{story:"Example showing that decorator props override parameter values.",...u.parameters?.docs?.description}}};const v=["WithTitleAndContent","WithStoryDescription","WithErrorStatus","WithWarnStatus","WithInfoStatus","WithCustomClassName","WithClassNameFunction","DecoratorPropsOverride"];export{u as DecoratorPropsOverride,p as WithClassNameFunction,l as WithCustomClassName,i as WithErrorStatus,c as WithInfoStatus,n as WithStoryDescription,o as WithTitleAndContent,d as WithWarnStatus,v as __namedExportsOrder,P as default};
