...
})`,...g.input.parameters?.docs?.source}}},_=[`WithClassName`,`WithStyle`,`BodyClass`,`BodyStyle`,`WithBodyTarget`]})))()}v();export{m as BodyClass,h as BodyStyle,g as WithBodyTarget,f as WithClassName,p as WithStyle,_ as __namedExportsOrder};