import"./components-DmejZTLj.js";import"./react-K5peCFg_.js";import"./react-dom-CYc0L8kE.js";import{t as e}from"./jsx-runtime-BUC2lftT.js";import{t}from"./dedent-rZS-CQtP.js";import{f as n,m as r}from"./src-CPfUkyQY.js";var i=e(),a={title:`storybook-addon-tag-badges/varBadge`,tags:[`var`,`!snapshot`,`version:2.16`],render:()=>(0,i.jsx)(i.Fragment,{})},o={name:`Variable Badge`,tags:[`var`],decorators:[n({content:(0,i.jsxs)(`p`,{children:[`Story that describes values and variables. In the sidebar it appears as `,(0,i.jsx)(`code`,{children:`var`}),`.`]})}),r({source:t`export default {
                tags: ['var'],
                // ...
            } satisfies Meta
...
}`,...s.parameters?.docs?.source}}};var c=[`VarBadge`,`DummyStory`];export{s as DummyStory,o as VarBadge,c as __namedExportsOrder,a as default};