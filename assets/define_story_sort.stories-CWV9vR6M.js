import{j as d}from"./jsx-runtime-D_zvdyIk.js";import{d as i}from"./dedent-DVFkJXTl.js";import{d as n}from"./define_docs_param-lmgaBKCF.js";import{s as I}from"./show_doc_source-CWgnZoeJ.js";function s(e){return{storySort:e}}const k={title:"parameters/defineStorySort",tags:["new","version:1.0.0"],decorators:[I()],render:()=>d.jsx(d.Fragment,{})},t={parameters:{...s({method:"alphabetical"}),...n({source:{code:'defineStorySort({ method: "alphabetical" })'}})}},o={parameters:{...s({method:"custom",order:["Introduction","Components","*","Examples"]}),...n({source:{code:i`defineStorySort({
                    method: "custom",
