import{j as c}from"./iframe-DL06NnA6.js";import{d as r}from"./dedent-D4JfOF0A.js";import"./show_source-D9XvUQww.js";import{s as m}from"./show_doc_source-CpLKGHoD.js";import{d as e}from"./define_parameters-BUOuTmGI.js";import"./preload-helper-PPVm8Dsz.js";const g={title:"parameters/defineParameters",tags:["autodocs","!snapshot","func","new","version:1.0"],decorators:[m()],parameters:e({docs:{description:{component:["`defineParameters` is used to define parameters for a story or component.","Note that it does not work in `preview.ts`, which requires the parameters to be inlined.","In that case, use the `satisfies StorybookBuiltInParams` instead."].join(`
...
}`,...d.parameters?.docs?.source}}};const y=["WithLayout","WithBackgroundsParam","WithDocsParam","WithViewportParam","WithOtherParams","WithActionsParam","ComposingParameters"];export{d as ComposingParameters,s as WithActionsParam,t as WithBackgroundsParam,n as WithDocsParam,a as WithLayout,i as WithOtherParams,o as WithViewportParam,y as __namedExportsOrder,g as default};
