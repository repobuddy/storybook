import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t}from"./chunk-W22LQPXL-B066xLLY.js";import{n,r}from"./iframe-DdoMirfh.js";import{n as i,t as a}from"./dedent-DQaCLeUO.js";import{O as o,_ as s,p as c,t as l}from"./src-Cjk9gBKT.js";var u,d,f,p,m,h,g;function _(){return(_=e((()=>{i(),l(),n(),u=t(),d=r.meta({title:`parameters/StorySortParam`,tags:[`type`,`!snapshot`,`version:1.0`,`autodocs`],decorators:[o()],parameters:c({docs:{description:{component:"`StorySortParam` is used to define how stories should be sorted in the navigation sidebar. It is used in `preview.ts`."}}}),render:()=>(0,u.jsx)(u.Fragment,{})}),f=d.story({parameters:{options:{options:{storySort:{method:`alphabetical`}}},...s({source:{code:a`{
                ...
                }`}})}}),g=[`AlphabeticalSort`,`CustomSort`,`AlphabeticalByKindSort`,`CustomSortFunction`],f.input.parameters={...f.input.parameters,docs:{...f.input.parameters?.docs,source:{originalSource:`meta.story({
  parameters: {
    options: {
      options: {
        storySort: {
...
})`,...h.input.parameters?.docs?.source}}}})))()}_();export{m as AlphabeticalByKindSort,f as AlphabeticalSort,p as CustomSort,h as CustomSortFunction,g as __namedExportsOrder};