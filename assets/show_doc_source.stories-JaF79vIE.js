import{j as e,t as D}from"./iframe-Qpe9uMKj.js";import{s as o}from"./show_doc_source-P8jpSjOy.js";import{w as r}from"./with_story_card-DNfTMKbt.js";import{d as s}from"./define_docs_param-lmgaBKCF.js";import"./preload-helper-PPVm8Dsz.js";const t=({text:c="Hello World"})=>e.jsx("div",{className:"rbsb:p-4 rbsb:bg-gray-100 rbsb:dark:bg-gray-500 rbsb:rounded",children:c}),H={title:"decorators/showDocSource",tags:["version:2.4"],render:()=>e.jsx(e.Fragment,{})},n={parameters:{docs:{source:{code:'() => /* from docs.source.code */ <DemoComponent text="Hello World" />'}}},decorators:[r({content:e.jsxs("p",{children:["When ",e.jsx("code",{children:"docs.source.code"})," is provided, the decorator will show it by default."]})}),o()],render:()=>e.jsx(t,{text:"Hello World"})},a={decorators:[r({content:e.jsx("p",{children:"When no `source` is provided, the decorator will use the original source code of the story."})}),o()],render:()=>e.jsx(t,{text:"Hello World"})},d={name:"With docs.source.language: json",parameters:s({source:{code:'{ "hello": "world" }',language:"json"}}),decorators:[r({content:e.jsxs("p",{children:["Use ",e.jsx("code",{children:"docs.source.language"})," to specify the language of the source code."]})}),o(),o({showOriginalSource:!0})]},i={name:"With docs.source.language: md",parameters:s({source:{code:"This is a `markdown` text",language:"md"}}),decorators:[r({content:e.jsxs("p",{children:["Use ",e.jsx("code",{children:"docs.source.language"})," to specify the language of the source code."]})}),o(),o({showOriginalSource:!0})]},u={name:"With docs.theme: dark",parameters:s({source:{code:"<div>Hello, World!</div>"},theme:D.dark}),decorators:[r({content:e.jsxs("p",{children:["Use ",e.jsx("code",{children:"docs.theme"})," to specify the theme of the source code."]})}),o(),o({showOriginalSource:!0})]},l={name:"showOriginalSource: true",tags:["props"],parameters:{docs:{source:{code:'() => <DemoComponent text="Hello World" />'}}},decorators:[r({content:e.jsxs("p",{children:["Use ",e.jsx("code",{children:"showOriginalSource: true"})," to show the source code of the story instead of the one in"," ",e.jsx("code",{children:"docs.source.code"}),"."]})}),o({showOriginalSource:!0})]},m={name:"className: string",tags:["props","version:2.5","!version:2.4"],parameters:s({source:{code:"<div>Hello, World!</div>"},description:{story:"Demonstrates using className as a string to add custom styling"}}),decorators:[o({className:"rbsb:bg-blue-500 rbsb:dark:bg-blue-900"})],render:()=>e.jsx(t,{text:"Custom border and shadow"})},p={name:"className: function",tags:["props","version:2.5","!version:2.4"],parameters:s({source:{code:"<div>Hello, World!</div>"},description:{story:"Demonstrates using className as a function to conditionally apply styles based on state"}}),decorators:[o({className:({defaultClassName:c})=>`${c} rbsb:border-2 rbsb:border-purple-500 rbsb:rounded-lg`})],render:()=>e.jsx(t,{text:"Function-based styling"})},h={name:"className: conditional function",tags:["props","version:2.5","!version:2.4"],parameters:s({source:{code:"<div>Hello, World!</div>"},description:{story:"Demonstrates using className function to access state and apply conditional styles"}}),decorators:[o({className:({defaultClassName:c,status:y})=>`${c} ${y==="info"?"rbsb:border-2 rbsb:border-blue-500 rbsb:ring-2 rbsb:ring-blue-200 rbsb:dark:ring-blue-800":"rbsb:border-2 rbsb:rounded-lg"}`})],render:()=>e.jsx(t,{text:"Conditional styling with function"})},S={name:"source: string",tags:["props","version:2.7","!version:2.4"],decorators:[r({content:e.jsxs("p",{children:["Pass ",e.jsx("code",{children:"source"})," as a string to the decorator to override the displayed source code."]})}),o({source:'() => <DemoComponent text="Hello World" />'})],render:()=>e.jsx(t,{text:"Hello World"})},b={name:"placement: 'before'",tags:["props","version:2.12","!version:2.4"],parameters:s({source:{code:'() => <DemoComponent text="Rendered below the source" />'},description:{story:"Use `placement: 'before'` to show the source code above the rendered story instead of below."}}),decorators:[r({content:e.jsxs("p",{children:["Use ",e.jsx("code",{children:"placement: 'before'"})," to display the source code card above the story output."]})}),o({placement:"before"})],render:()=>e.jsx(t,{text:"Rendered below the source"})},g={name:"two showDocSource (placement: 'before')",tags:["unit","!version:2.4","snapshot"],parameters:s({source:{code:'() => <DemoComponent text="Story content" />'},description:{story:"With two showDocSource(placement: 'before'), cards are rendered in decorator order: first source card, second source card, then the story."}}),decorators:[o({placement:"before",source:"// First source block"}),o({placement:"before",source:"// Second source block"})],render:()=>e.jsx(t,{text:"Story content"})},w={name:"two showDocSource (placement: 'after' / default)",tags:["unit","!version:2.4","snapshot"],parameters:s({source:{code:'() => <DemoComponent text="Story content" />'},description:{story:"With two showDocSource() (placement defaults to 'after'), order is: story first, then first source card, then second source card."}}),decorators:[o({source:"// First source block"}),o({source:"// Second source block"})],render:()=>e.jsx(t,{text:"Story content"})},f={name:"two withStoryCard + two showDocSource",tags:["unit","!version:2.4","snapshot"],parameters:s({source:{code:'() => <DemoComponent text="Story content" />'},description:{story:"Cards render in decorator order: First card (withStoryCard), source before (showDocSource placement: 'before'), second card (withStoryCard), story, then source after (showDocSource)."}}),decorators:[r({title:"First card",content:e.jsx("p",{children:"This card should appear first."})}),o({placement:"before",source:"// Source shown before the story"}),r({title:"Second card",content:e.jsx("p",{children:"This card should appear after the first source."})}),o({source:"// Source shown after the story"})],render:()=>e.jsx(t,{text:"Story content"})};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  ...
  render: () => <DemoComponent text="Story content" />
}`,...f.parameters?.docs?.source}}};const k=["ShowDocsSourceCode","ShowStorySource","WithLanguageJson","WithLanguageMd","WithDocsTheme","ShowDocsSource","WithClassNameString","WithClassNameFunction","WithClassNameConditional","WithSourceString","PlacementBefore","TwoShowDocSourceBefore","TwoShowDocSourceAfter","TwoWithStoryCardTwoShowDocSource"];export{b as PlacementBefore,l as ShowDocsSource,n as ShowDocsSourceCode,a as ShowStorySource,w as TwoShowDocSourceAfter,g as TwoShowDocSourceBefore,f as TwoWithStoryCardTwoShowDocSource,h as WithClassNameConditional,p as WithClassNameFunction,m as WithClassNameString,u as WithDocsTheme,d as WithLanguageJson,i as WithLanguageMd,S as WithSourceString,k as __namedExportsOrder,H as default};
