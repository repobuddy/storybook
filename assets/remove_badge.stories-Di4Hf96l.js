import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t}from"./chunk-W22LQPXL-B066xLLY.js";import{n,r}from"./iframe-B3mkwjL8.js";import{n as i,t as a}from"./dedent-DQaCLeUO.js";import{O as o,t as s,w as c}from"./src-Cjk9gBKT.js";var l,u,d,f,p,m;function h(){return(h=e((()=>{i(),s(),n(),l=t(),u=r.meta({title:`storybook-addon-tag-badges/removeBadge`,tags:[`var`,`!snapshot`,`version:2.19`],render:()=>(0,l.jsx)(l.Fragment,{})}),d=u.story({tags:[`remove:2`],decorators:[c({content:(0,l.jsxs)(`p`,{children:[`Feature or component scheduled for removal in version 2.0.0. In the sidebar it appears as `,(0,l.jsx)(`code`,{children:`☠️v2`}),`.`]})}),o({source:a`export const YourStory = {
                ...
                tags: ['remove:next'],
                render: () => <YourComponent />
            }`})]}),m=[`RemoveInVersion`,`RemovePlain`,`RemoveInNext`],d.input.parameters={...d.input.parameters,docs:{...d.input.parameters?.docs,source:{originalSource:`meta.story({
  tags: ['remove:2'],
...
})`,...p.input.parameters?.docs?.source},description:{story:"Same badge as RemovePlain; `remove` and `remove:next` are equivalent.",...p.input.parameters?.docs?.description}}}})))()}h();export{p as RemoveInNext,d as RemoveInVersion,f as RemovePlain,m as __namedExportsOrder};