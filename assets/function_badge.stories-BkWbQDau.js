import{j as o}from"./iframe-D1XledYu.js";import{d as e}from"./dedent-BuYMbVyj.js";import{s}from"./show_doc_source-CLNO4AjV.js";import{w as n}from"./with_story_card-CdEn_QAt.js";import"./preload-helper-PPVm8Dsz.js";const m={title:"storybook-addon-tag-badges/functionBadge",tags:["var","version:2.16"],render:()=>o.jsx(o.Fragment,{})},r={tags:["func"],decorators:[n({content:o.jsxs("p",{children:["Story that showcases or documents functions. In the sidebar it appears as ",o.jsx("code",{children:"ƒ(x)"}),"."]})}),s({source:e`export const YourStory = {
                tags: ['func'],
