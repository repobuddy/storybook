import{n as e}from"./chunk-DnJy8xQt.js";import{t}from"./jsx-runtime-DC6t-S6Q.js";import{_ as n,i as r,y as i}from"./iframe-BsHda9nq.js";import{n as a,t as o}from"./dedent-DU6uki2e.js";var s,c,l,u;e((()=>{a(),r(),s=t(),c={title:`storybook-addon-tag-badges/perfBadge`,tags:[`var`,`!snapshot`,`version:2.22`],render:()=>(0,s.jsx)(s.Fragment,{})},l={tags:[`perf`],decorators:[n({content:(0,s.jsx)(s.Fragment,{children:(0,s.jsxs)(`p`,{children:[`Story that demonstrates or tests performance. In the sidebar it appears as `,(0,s.jsx)(`code`,{children:`⚡`}),`.`]})})}),i({placement:`before`,source:o`export const YourStory = {
                tags: ['perf'],
                render: () => <YourComponent />
            }`}),n({content:(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(`p`,{children:`To skip perf stories in Vitest:`}),(0,s.jsxs)(`ol`,{children:[(0,s.jsxs)(`li`,{children:[`Tag the story with `,(0,s.jsx)(`code`,{children:`perf`}),` (e.g. `,(0,s.jsx)(`code`,{children:`tags: ['perf']`}),`).`]}),(0,s.jsxs)(`li`,{children:[`In your Vitest browser config, pass `,(0,s.jsx)(`code`,{children:`tags: { exclude: ['perf'] }`}),` to`,` `,(0,s.jsx)(`code`,{children:`storybookTest()`}),` so those stories are not run and are not counted in results.`]})]})]})}),i({placement:`before`,source:o`
            // vitest.config.ts
