import{j as t}from"./iframe-MGoJO9mD.js";import{d as e}from"./dedent-BuYMbVyj.js";import{s as b,w as s}from"./with_story_card-DP-uGO5A.js";import{d as r}from"./define_docs_param-lmgaBKCF.js";import"./preload-helper-PPVm8Dsz.js";function a(m){return{storyCard:m}}const T={title:"parameters/defineStoryCard",tags:["new","version:2.9"],decorators:[b()],render:()=>t.jsx("p",{children:"This is the story content"})},o={parameters:{...a({title:"Important Notice",status:"info",content:t.jsx("p",{children:"This is a custom message displayed in the card."})}),...r({source:{code:e`defineStoryCard({
                    title: 'Important Notice',
                    status: 'info',
                    content: <p>This is a custom message displayed in the card.</p>
                })`}})},decorators:[s()]},n={parameters:{...r({description:{story:"This description will be automatically shown in the card."}}),...a({title:"Story Information",status:"info"}),...r({source:{code:e`defineStoryCard({
                    title: 'Story Information',
                    status: 'info'
                })`}})},decorators:[s()]},i={parameters:{...a({title:"Error Card",status:"error",content:t.jsx("p",{children:"This card displays an error status with red background styling."})}),...r({source:{code:e`defineStoryCard({
                    title: 'Error Card',
                    status: 'error',
                    content: <p>This card displays an error status with red background styling.</p>
                })`}})},decorators:[s()]},d={parameters:{...a({title:"Warning Card",status:"warn",content:t.jsx("p",{children:"This card displays a warning status with yellow background styling."})}),...r({source:{code:e`defineStoryCard({
                    title: 'Warning Card',
                    status: 'warn',
                    content: <p>This card displays a warning status with yellow background styling.</p>
                })`}})},decorators:[s()]},c={parameters:{...a({title:"Info Card",status:"info",content:t.jsx("p",{children:"This card displays an info status with blue background styling. This is the default status."})}),...r({source:{code:e`defineStoryCard({
                    title: 'Info Card',
                    status: 'info',
                    content: <p>This card displays an info status with blue background styling. This is the default status.</p>
                })`}})},decorators:[s()]},l={parameters:{...a({title:"Custom Styled Card",status:"info",content:t.jsx("p",{children:"This card has custom border styling applied via className."}),className:"rbsb:border-2 rbsb:border-blue-500 rbsb:shadow-lg"}),...r({source:{code:e`defineStoryCard({
                ...
                })`}})},decorators:[s()]},p={parameters:{...a({title:"Function-Based Styling",status:"info",content:t.jsx("p",{children:"This card uses a function to compute className based on the card state."}),className:({status:m,defaultClassName:h})=>`${h} rbsb:border-2 ${m==="info"?"rbsb:border-green-500":m==="warn"?"rbsb:border-yellow-500":"rbsb:border-red-500"} rbsb:shadow-lg`}),...r({source:{code:e`defineStoryCard({
                ...
                })`}})},decorators:[s()]},u={parameters:{...a({title:"Parameter Title",status:"info",content:t.jsx("p",{children:"This content will be overridden by the decorator."})}),...r({source:{code:e`// Parameters define default values
                defineStoryCard({
                ...
                })`}})},decorators:[s({title:"Decorator Title",status:"warn",content:t.jsx("p",{children:"This content comes from the decorator and overrides the parameter values."})})]};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  parameters: {
    ...defineStoryCard({
      title: 'Important Notice',
      status: 'info',
