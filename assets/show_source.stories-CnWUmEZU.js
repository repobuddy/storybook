import{i as e}from"./preload-helper-Cs4UwXAW.js";import{St as t,lt as n,mt as r}from"./iframe-CNp9swqD.js";import{n as i,t as a}from"./dedent-DwYWIg5g.js";import{d as o,g as s,m as c,t as l,v as u,y as d}from"./src-D1u8VeGW.js";var f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z;e((()=>{i(),r(),u(),l(),f=n(),{expect:p}=__STORYBOOK_MODULE_TEST__,m=({text:e=`Hello World`})=>(0,f.jsx)(`div`,{className:`rbsb:p-4 rbsb:bg-gray-100 rbsb:dark:bg-gray-500 rbsb:rounded`,children:e}),h={title:`decorators/showSource`,tags:[`version:2.22`,`!snapshot`],render:()=>(0,f.jsx)(f.Fragment,{})},g={name:`Show docs.source.code`,tags:[`use-case`],parameters:{docs:{source:{code:`() => /* from docs.source.code */ <DemoComponent text="Hello World" />`}}},decorators:[c({content:(0,f.jsxs)(`p`,{children:[`When `,(0,f.jsx)(`code`,{children:`docs.source.code`}),` is provided, the decorator will show it by default.`]})}),s({source:a`{
            ...
            decorators: [showSource()]
              ...
              decorators: [showSource()]
                ...
                decorators: [showSource()]
            }`}),s()]},b={name:`With docs.theme: dark`,parameters:o({source:{code:`<div>Hello, World!</div>`},theme:t.dark}),decorators:[c({content:(0,f.jsxs)(`p`,{children:[`Use `,(0,f.jsx)(`code`,{children:`docs.theme`}),` to specify the theme of the source code.`]})}),s({source:a`{
                parameters: defineDocsParam({
                    source: {
