import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{n,t as r}from"./dedent-DQaCLeUO.js";import{O as i,_ as a,p as o,t as s,w as c}from"./src-yOJfan-s.js";var l,u,d,f,p,m,h,g,_;function v(){return(v=e((()=>{n(),s(),l=t(),u=r`// storySort must be a self-contained inline function — Storybook 10+ performs
    ...
    storySort: (a, b) => {
        ...
        function indexIn(name, orderList) {
            ...
            return -1
    ...
    }`,d={title:`parameters/storySort`,tags:[`version:2.30`,`func`],decorators:[c(),i()],parameters:o({docs:{description:{component:r`The \`storySort\` inline function sorts stories by kind (title hierarchy) and then by tag category within the same component. Docs entries (autodocs and MDX) always appear first within a component.
                ...
                - **\`tag\`** — story tags in the desired order within a component; \`'*'\` is the wildcard for unlisted tags`}}}),render:()=>(0,l.jsx)(l.Fragment,{})},f={tags:[`use-case`],parameters:{...a({description:{story:"Copy this block into your `.storybook/preview.ts` and customize the `order` and `tag` arrays at the top."},source:{code:u}})}},p={tags:[`use-case`],parameters:{...a({description:{story:"Sort only by title hierarchy order. Set `tag` to an empty array to skip tag-based sorting; stories within the same component fall back to alphabetical name sorting."},source:{code:r`const order = ['Introduction', 'Components', 'Hooks', '*', 'Utilities']
                const tag   = []`}})}},m={tags:[`use-case`],parameters:{...a({description:{story:"Sort only by tag priority within the same component. Set `order` to an empty array to skip title-based ordering; titles fall back to alphabetical sorting."},source:{code:r`const order = []
                const tag   = ['playground', 'use-case', 'example', 'spec', 'props', '*', 'edge-case', 'unit', 'integration']`}})}},h={tags:[`use-case`],parameters:{...a({description:{story:"Nested ordering uses tuples `[name, children]` to control sub-level sort order."},source:{code:r`const order = ['Overview', ['Components', ['Button', 'Input', 'Select']], '*', 'WIP']
                const tag   = ['playground', 'use-case', '*']`}})}},g={tags:[`use-case`],parameters:{...a({description:{story:"The `*` wildcard controls where unlisted items appear. Items before `*` sort first, items after `*` sort last, and unlisted items land at the `*` position sorted alphabetically."},source:{code:r`const order = ['First', '*', 'Last']
...
}`,...g.parameters?.docs?.source}}},_=[`BasicUsage`,`OrderOnly`,`TagOnly`,`NestedOrder`,`WildcardPositioning`]})))()}v();export{f as BasicUsage,h as NestedOrder,p as OrderOnly,m as TagOnly,g as WildcardPositioning,_ as __namedExportsOrder,d as default};