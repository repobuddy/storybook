import{j as e}from"./iframe-8Fqjj6Pb.js";import{d as t}from"./dedent-BuYMbVyj.js";import{s}from"./show_doc_source-BHZWkkJT.js";import{w as a}from"./with_story_card-B-1QmyvR.js";import"./preload-helper-PPVm8Dsz.js";const m={title:"storybook-addon-tag-badges/typeBadge",tags:["var","version:2.15"],render:()=>e.jsx(e.Fragment,{})},o={tags:["type"],decorators:[a({content:e.jsxs("p",{children:["Story that showcases or documents TypeScript types. In the sidebar it appears as ",e.jsx("code",{children:"<T>"}),"."]})}),s({source:t`export const YourStory = {
                tags: ['type'],
