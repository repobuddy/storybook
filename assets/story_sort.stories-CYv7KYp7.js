import{j as c}from"./iframe-BYcs46e2.js";import{d as s}from"./dedent-BuYMbVyj.js";import{s as m}from"./show_doc_source-BuwyARAu.js";import{d as a}from"./define_docs_param-lmgaBKCF.js";import{d}from"./define_parameters-BUOuTmGI.js";import"./preload-helper-PPVm8Dsz.js";const h={title:"parameters/StorySortParam",tags:["new","!snapshot","version:1.0","autodocs"],decorators:[m()],parameters:d({docs:{description:{component:"`StorySortParam` is used to define how stories should be sorted in the navigation sidebar. It is used in `preview.ts`."}}}),render:()=>c.jsx(c.Fragment,{})},o={parameters:{options:{options:{storySort:{method:"alphabetical"}}},...a({source:{code:s`{
                    options: {
