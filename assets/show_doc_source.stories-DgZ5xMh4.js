import{j as e,t as x}from"./iframe-CPpg16TU.js";import"./show_source-CRov7rlt.js";import{s as o}from"./show_doc_source-DH7autsT.js";import{w as r}from"./with_story_card-Cp4orGqg.js";import{d as s}from"./define_docs_param-lmgaBKCF.js";import"./preload-helper-PPVm8Dsz.js";const t=({text:c="Hello World"})=>e.jsx("div",{className:"rbsb:p-4 rbsb:bg-gray-100 rbsb:dark:bg-gray-500 rbsb:rounded",children:c}),k={title:"decorators/showDocSource",tags:["deprecated","version:2.22","!snapshot"],decorators:[r({appearance:"warn",content:e.jsxs("p",{children:["This decorator is deprecated. Use ",e.jsx("code",{children:"showSource"})," instead."]})})],render:()=>e.jsx(e.Fragment,{})},n={parameters:{docs:{source:{code:'() => /* from docs.source.code */ <DemoComponent text="Hello World" />'}}},decorators:[r({content:e.jsxs("p",{children:["When ",e.jsx("code",{children:"docs.source.code"})," is provided, the decorator will show it by default."]})}),o()],render:()=>e.jsx(t,{text:"Hello World"})},a={decorators:[r({content:e.jsx("p",{children:"When no `source` is provided, the decorator will use the original source code of the story."})}),o()],render:()=>e.jsx(t,{text:"Hello World"})},d={name:"With docs.source.language: json",parameters:s({source:{code:'{ "hello": "world" }',language:"json"}}),decorators:[r({content:e.jsxs("p",{children:["Use ",e.jsx("code",{children:"docs.source.language"})," to specify the language of the source code."]})}),o(),o({showOriginalSource:!0})]},i={name:"With docs.source.language: md",parameters:s({source:{code:"This is a `markdown` text",language:"md"}}),decorators:[r({content:e.jsxs("p",{children:["Use ",e.jsx("code",{children:"docs.source.language"})," to specify the language of the source code."]})}),o(),o({showOriginalSource:!0})]},u={name:"With docs.theme: dark",parameters:s({source:{code:"<div>Hello, World!</div>"},theme:x.dark}),decorators:[r({content:e.jsxs("p",{children:["Use ",e.jsx("code",{children:"docs.theme"})," to specify the theme of the source code."]})}),o(),o({showOriginalSource:!0})]},l={name:"showOriginalSource: true",tags:["props"],parameters:{docs:{source:{code:'() => <DemoComponent text="Hello World" />'}}},decorators:[r({content:e.jsxs("p",{children:["Use ",e.jsx("code",{children:"showOriginalSource: true"})," to show the source code of the story instead of the one in"," ",e.jsx("code",{children:"docs.source.code"}),"."]})}),o({showOriginalSource:!0})]},m={name:"className: string",tags:["props"],parameters:s({source:{code:"<div>Hello, World!</div>"},description:{story:"Demonstrates using className as a string to add custom styling"}}),decorators:[o({className:"rbsb:bg-blue-500 rbsb:dark:bg-blue-900"})],render:()=>e.jsx(t,{text:"Custom border and shadow"})},p={name:"className: function",tags:["props"],parameters:s({source:{code:"<div>Hello, World!</div>"},description:{story:"Demonstrates using className as a function to conditionally apply styles based on state"}}),decorators:[o({className:({defaultClassName:c})=>`${c} rbsb:border-2 rbsb:border-purple-500 rbsb:rounded-lg`})],render:()=>e.jsx(t,{text:"Function-based styling"})},h={name:"className: conditional function",tags:["props"],parameters:s({source:{code:"<div>Hello, World!</div>"},description:{story:"Demonstrates using className function to access state and apply conditional styles"}}),decorators:[o({className:({defaultClassName:c,status:D})=>`${c} ${D==="info"?"rbsb:border-2 rbsb:border-blue-500 rbsb:ring-2 rbsb:ring-blue-200 rbsb:dark:ring-blue-800":"rbsb:border-2 rbsb:rounded-lg"}`})],render:()=>e.jsx(t,{text:"Conditional styling with function"})},S={name:"source: string",tags:["props"],decorators:[r({content:e.jsxs("p",{children:["Pass ",e.jsx("code",{children:"source"})," as a string to the decorator to override the displayed source code."]})}),o({source:'() => <DemoComponent text="Hello World" />'})],render:()=>e.jsx(t,{text:"Hello World"})},g={name:"source: function",tags:["props"],parameters:s({source:{code:'() => <DemoComponent text="Hello World" />'},description:{story:"Pass source as a function (originalSource) => string to transform the story source before displaying."}}),decorators:[r({content:e.jsxs("p",{children:["Pass ",e.jsx("code",{children:"source"})," as a function to transform the original source. The function receives the story's source and returns the code to display."]})}),o({source:c=>`// Wrapped by source function
${c??""}
