import{j as i}from"./iframe-CKjSMc0F.js";import{s as d}from"./with_story_card-CnEAkYrX.js";import{d as a}from"./define_docs_param-lmgaBKCF.js";import{d as o}from"./dedent-BuYMbVyj.js";import"./preload-helper-PPVm8Dsz.js";function t(c){return{actions:c}}const{fn:m}=__STORYBOOK_MODULE_TEST__,h={title:"Parameters/defineActionsParam",tags:["new","version:1.0"],decorators:[d()],args:{onClick:m()},render:()=>i.jsx(i.Fragment,{})},e={parameters:{...t({argTypesRegex:"^on[A-Z].*"}),...a({source:{code:o`defineActionsParam({
