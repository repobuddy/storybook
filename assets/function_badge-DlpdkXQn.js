...
`})}),`
`,(0,c.jsxs)(t.p,{children:[`Stories in a file whose meta is tagged with `,(0,c.jsx)(t.code,{children:`func`}),` will show the `,(0,c.jsx)(t.strong,{children:`ƒ(x)`}),` badge in the sidebar.`]})]})}function s(e={}){let{wrapper:t}={...i(),...e.components};return t?(0,c.jsx)(t,{...e,children:(0,c.jsx)(o,{...e})}):o(e)}var c;function l(){return(l=e((()=>{c=t(),a(),n()})))()}l();export{s as default};