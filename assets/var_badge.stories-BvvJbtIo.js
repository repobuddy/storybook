import{j as r}from"./iframe-YuPB_Tle.js";import{d as a}from"./dedent-BuYMbVyj.js";import"./show_source-C1ULL-zP.js";import{s as t}from"./show_doc_source-C952wXi_.js";import{w as s}from"./with_story_card-BFcUoUsC.js";import"./preload-helper-PPVm8Dsz.js";const u={title:"storybook-addon-tag-badges/varBadge",tags:["var","!snapshot","version:2.16"],render:()=>r.jsx(r.Fragment,{})},e={name:"Variable Badge",tags:["var"],decorators:[s({content:r.jsxs("p",{children:["Story that describes values and variables. In the sidebar it appears as ",r.jsx("code",{children:"var"}),"."]})}),t({source:a`export default {
                tags: ['var'],
                // ...
            } satisfies Meta
