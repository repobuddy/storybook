import{j as c}from"./jsx-runtime-D_zvdyIk.js";import{d as t}from"./dedent-DVFkJXTl.js";import"./show_html-C2QZHDjw.js";import{s as P}from"./show_doc_source-CWgnZoeJ.js";import{d as s}from"./define_docs_param-lmgaBKCF.js";import"./index-D4lIrffr.js";const w={title:"Parameters/defineDocsParam",tags:["autodocs","new","version:1.0"],parameters:s({description:{component:"`docs.description.component` can be used to describe the component in meta. It has no effect on the stories."}}),decorators:[P()],render:()=>c.jsx(c.Fragment,{})},e={parameters:s({source:{code:t`
            /**
...
}`,...(D=(f=o.parameters)==null?void 0:f.docs)==null?void 0:D.source},description:{story:"`docs.source.code` can be used to define the source code of the story.",...(b=(h=o.parameters)==null?void 0:h.docs)==null?void 0:b.description}}};const C=["JSDoc","WithStoryDescription","SourceCode"];export{e as JSDoc,o as SourceCode,r as WithStoryDescription,C as __namedExportsOrder,w as default};
