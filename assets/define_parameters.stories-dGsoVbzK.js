import{j as c}from"./iframe-BrhKh24D.js";import{d as r}from"./dedent-BuYMbVyj.js";import{s as m}from"./show_doc_source-B7BaSV80.js";import{d as e}from"./define_parameters-BUOuTmGI.js";import"./preload-helper-PPVm8Dsz.js";const P={title:"parameters/defineParameters",tags:["autodocs","func","new","version:1.0"],decorators:[m()],parameters:e({docs:{description:{component:["`defineParameters` is used to define parameters for a story or component.","Note that it does not work in `preview.ts`, which requires the parameters to be inlined.","In that case, use the `satisfies StorybookBuiltInParams` instead."].join(`
