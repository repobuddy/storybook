...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Specific version:"})," ",e.jsx(n.code,{children:"remove:<version>"})," with a single version number (e.g. ",e.jsx(n.code,{children:"remove:2"}),")"]}),`
`]}),`
