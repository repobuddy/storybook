import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{n,t as r}from"./dedent-DQaCLeUO.js";import{O as i,_ as a,d as o,t as s,w as c}from"./src-yOJfan-s.js";var l,u,d,f,p,m,h,g,_,v,y;function b(){return(b=e((()=>{n(),s(),l=t(),u={title:`parameters/defineStoryCard`,tags:[`func`,`new`,`version:2.9`],decorators:[i()],render:()=>(0,l.jsx)(`p`,{children:`This is the story content`})},d={parameters:{...o({title:`Important Notice`,status:`info`,content:(0,l.jsx)(`p`,{children:`This is a custom message displayed in the card.`})}),...a({source:{code:r`defineStoryCard({
                    title: 'Important Notice',
                    status: 'info',
                    content: <p>This is a custom message displayed in the card.</p>
                })`}})},decorators:[c()]},f={parameters:{...a({description:{story:`This description will be automatically shown in the card.`}}),...o({title:`Story Information`,status:`info`}),...a({source:{code:r`defineStoryCard({
                    title: 'Story Information',
                    status: 'info'
                })`}})},decorators:[c()]},p={parameters:{...o({title:`Error Card`,status:`error`,content:(0,l.jsx)(`p`,{children:`This card displays an error status with red background styling.`})}),...a({source:{code:r`defineStoryCard({
                    title: 'Error Card',
                    status: 'error',
                    content: <p>This card displays an error status with red background styling.</p>
                })`}})},decorators:[c()]},m={parameters:{...o({title:`Warning Card`,status:`warn`,content:(0,l.jsx)(`p`,{children:`This card displays a warning status with yellow background styling.`})}),...a({source:{code:r`defineStoryCard({
                    title: 'Warning Card',
                    status: 'warn',
                    content: <p>This card displays a warning status with yellow background styling.</p>
                })`}})},decorators:[c()]},h={parameters:{...o({title:`Info Card`,status:`info`,content:(0,l.jsx)(`p`,{children:`This card displays an info status with blue background styling. This is the default status.`})}),...a({source:{code:r`defineStoryCard({
                    title: 'Info Card',
                    status: 'info',
                    content: <p>This card displays an info status with blue background styling. This is the default status.</p>
                })`}})},decorators:[c()]},g={parameters:{...o({title:`Custom Styled Card`,status:`info`,content:(0,l.jsx)(`p`,{children:`This card has custom border styling applied via className.`}),className:`rbsb:border-2 rbsb:border-blue-500 rbsb:shadow-lg`}),...a({source:{code:r`defineStoryCard({
                ...
                })`}})},decorators:[c()]},v={parameters:{...o({title:`Parameter Title`,status:`info`,content:(0,l.jsx)(`p`,{children:`This content will be overridden by the decorator.`})}),...a({source:{code:r`// Parameters define default values
                defineStoryCard({
                ...
                })`}})},decorators:[c({title:`Decorator Title`,status:`warn`,content:(0,l.jsx)(`p`,{children:`This content comes from the decorator and overrides the parameter values.`})})]},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  parameters: {
