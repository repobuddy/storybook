import{j as t}from"./iframe-LNk-wMqE.js";import{w as o,s as r}from"./with_story_card-BPnILLEQ.js";import{d as s}from"./define_docs_param-lmgaBKCF.js";import{d as a}from"./dedent-BuYMbVyj.js";import{t as e}from"./test_type-B2D-ob_P.js";import"./preload-helper-PPVm8Dsz.js";const i={title:"arg-types/FnToArgTypes",tags:["version:2.6"],decorators:[r()],render:()=>t.jsx(t.Fragment,{})},n={parameters:s({source:{code:a`
                // test-subject.ts
                ...
                export default meta
                `}}),decorators:[o({title:"FnToArgTypes",content:t.jsxs("p",{children:[t.jsx("code",{children:"FnToArgTypes<F, Names>"})," converts a function's parameter types to ",t.jsx("code",{children:"Args"})," type for Storybook."]})})],async play(){e.equal(!0),e.equal(!0),e.equal(!0),e.equal(!0),e.equal(!0),e.equal(!0)}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
