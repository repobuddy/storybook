import{j as e}from"./iframe-BviagkjD.js";import{d as n}from"./dedent-BuYMbVyj.js";import{s}from"./show_doc_source-BIuCeZCU.js";import{w as a}from"./with_story_card-cMVAmOE0.js";import"./preload-helper-PPVm8Dsz.js";const u={title:"storybook-addon-tag-badges/removeBadge",tags:["var","version:next"],render:()=>e.jsx(e.Fragment,{})},t={tags:["remove:2"],decorators:[a({content:e.jsxs("p",{children:["Feature or component scheduled for removal in version 2.0.0. In the sidebar it appears as ",e.jsx("code",{children:"☠️v2"}),"."]})}),s({source:n`export const YourStory = {
                tags: ['remove:2'],
