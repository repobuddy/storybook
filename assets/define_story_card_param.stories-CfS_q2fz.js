import{i as e}from"./preload-helper-Cs4UwXAW.js";import{lt as t}from"./iframe-CNp9swqD.js";import{n,t as r}from"./dedent-DwYWIg5g.js";import{c as i,d as a,g as o,m as s,t as c}from"./src-D1u8VeGW.js";var l,u,d,f,p,m,h,g,_,v,y;e((()=>{n(),c(),l=t(),u={title:`parameters/defineStoryCard`,tags:[`func`,`new`,`version:2.9`],decorators:[o()],render:()=>(0,l.jsx)(`p`,{children:`This is the story content`})},d={parameters:{...i({title:`Important Notice`,status:`info`,content:(0,l.jsx)(`p`,{children:`This is a custom message displayed in the card.`})}),...a({source:{code:r`defineStoryCard({
