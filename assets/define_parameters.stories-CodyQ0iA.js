import{n as e}from"./chunk-DnJy8xQt.js";import{t}from"./jsx-runtime-DC6t-S6Q.js";import{f as n,i as r,v as i}from"./iframe-BsHda9nq.js";import{n as a,t as o}from"./dedent-DU6uki2e.js";var s,c,l,u,d,f,p,m,h,g;e((()=>{a(),r(),s=t(),c={title:`parameters/defineParameters`,tags:[`autodocs`,`!snapshot`,`func`,`new`,`version:1.0`],decorators:[i()],parameters:n({docs:{description:{component:["`defineParameters` is used to define parameters for a story or component.","Note that it does not work in `preview.ts`, which requires the parameters to be inlined.","In that case, use the `satisfies StorybookBuiltInParams` instead."].join(`
`)}}}),render:()=>(0,s.jsx)(s.Fragment,{})},l={parameters:n({layout:`centered`,docs:{source:{code:o`defineParameters({
                layout: 'centered'
            })`}}})},u={parameters:n({backgrounds:{default:`light`},docs:{source:{code:o`defineParameters({
                backgrounds: {
                    default: 'light'
                }
            })`}}})},d={parameters:n({docs:{description:{story:`This is a story`},source:{code:o`defineParameters({
                docs: {
                    description: {
                        story: 'This is a story'
                    }
                }
            })`}}})},f={parameters:n({viewport:{defaultViewport:`tablet1`},docs:{source:{code:o`defineParameters({
                viewport: {
                    defaultViewport: 'tablet1'
                }
            })`}}})},p={parameters:n({something:{blah:`beer`},docs:{source:{code:o`defineParameters({
                something: {
                    blah: 'beer'
                }
            })`}}}),render:()=>(0,s.jsx)(`div`,{children:`You can use this to configure parameters that are not defined in the type`})},m={parameters:n({actions:{argTypesRegex:`^on[A-Z].*`}},{docs:{source:{code:o`defineParameters<ActionsParam>({
                actions: {
                    argTypesRegex: '^on[A-Z].*'
                }
            })`}}})},h={parameters:n({layout:`centered`},{docs:{description:{story:`This is a story`},source:{code:o`defineParameters(
                    { layout: 'centered' },
