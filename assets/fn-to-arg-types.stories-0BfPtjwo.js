import{j as t}from"./iframe-Ciex6Z86.js";import{s as o,w as r}from"./with_story_card-pwZA-g7Q.js";import{d as s}from"./define_docs_param-lmgaBKCF.js";import{d as a}from"./dedent-BuYMbVyj.js";import{t as e}from"./test_type-B2D-ob_P.js";import"./preload-helper-PPVm8Dsz.js";const i={title:"arg-types/FnToArgTypes",tags:["version:next"],decorators:[o()],render:()=>t.jsx(t.Fragment,{})},n={parameters:s({source:{code:a`
                // test-subject.ts
                ...
                export default meta
                `}}),decorators:[r({title:"FnToArgTypes",content:t.jsxs("p",{children:[t.jsx("code",{children:"FnToArgTypes<F, Names>"})," converts a function's parameter types to ",t.jsx("code",{children:"Args"})," type for Storybook."]})})],async play(){e.equal(!0),e.equal(!0),e.equal(!0),e.equal(!0),e.equal(!0),e.equal(!0)}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
...
}`,...n.parameters?.docs?.source}}};const b=["BasicUsage"];export{n as BasicUsage,b as __namedExportsOrder,i as default};
