import{j as e,t as D}from"./iframe-BJ-riZOY.js";import{d as c}from"./dedent-BuYMbVyj.js";import{s as o,t as j}from"./show_source-DxRl531K.js";import{w as r}from"./with_story_card-DSl7Nptl.js";import{d as s}from"./define_docs_param-lmgaBKCF.js";import"./preload-helper-PPVm8Dsz.js";const a=({text:t="Hello World"})=>e.jsx("div",{className:"rbsb:p-4 rbsb:bg-gray-100 rbsb:dark:bg-gray-500 rbsb:rounded",children:t}),U={title:"decorators/showSource",tags:["version:next","!snapshot"],render:()=>e.jsx(e.Fragment,{})},n={name:"Show docs.source.code",tags:["use-case"],parameters:{docs:{source:{code:'() => /* from docs.source.code */ <DemoComponent text="Hello World" />'}}},decorators:[r({content:e.jsxs("p",{children:["When ",e.jsx("code",{children:"docs.source.code"})," is provided, the decorator will show it by default."]})}),o({source:c`{
