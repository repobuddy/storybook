import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{n,t as r}from"./dedent-DQaCLeUO.js";import{O as i,p as a,t as o}from"./src-D21r-Siz.js";var s,c,l,u,d,f,p,m,h,g;function _(){return(_=e((()=>{n(),o(),s=t(),c={title:`parameters/defineParameters`,tags:[`autodocs`,`!snapshot`,`func`,`new`,`version:1.0`],decorators:[i()],parameters:a({docs:{description:{component:["`defineParameters` is used to define parameters for a story or component.","Note that it does not work in `preview.ts`, which requires the parameters to be inlined.","In that case, use the `satisfies StorybookBuiltInParams` instead."].join(`
...
}`,...h.parameters?.docs?.source}}},g=[`WithLayout`,`WithBackgroundsParam`,`WithDocsParam`,`WithViewportParam`,`WithOtherParams`,`WithActionsParam`,`ComposingParameters`]})))()}_();export{h as ComposingParameters,m as WithActionsParam,u as WithBackgroundsParam,d as WithDocsParam,l as WithLayout,p as WithOtherParams,f as WithViewportParam,g as __namedExportsOrder,c as default};