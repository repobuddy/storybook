import{j as s}from"./iframe-DpHjNuS4.js";import{s as d}from"./with_story_card-flwRQf2f.js";import{d as o}from"./define_docs_param-lmgaBKCF.js";import{d as n}from"./dedent-BuYMbVyj.js";import"./preload-helper-PPVm8Dsz.js";function i(p){return{viewport:p}}const f={title:"Parameters/defineViewportParam",tags:["new","version:1.0","autodocs"],decorators:[d()],render:()=>s.jsx(s.Fragment,{})},e={parameters:{...i({defaultViewport:"mobile1",viewports:{mobile1:{name:"Mobile",styles:{width:"320px",height:"568px"},type:"mobile"},tablet1:{name:"Tablet",styles:{width:"768px",height:"1024px"},type:"tablet"}}}),...o({source:{code:n`defineViewportParam({
