import{n as e}from"./chunk-DnJy8xQt.js";import{t}from"./jsx-runtime-DC6t-S6Q.js";import{C as n,E as r,_ as i,i as a,m as o,v as s,x as c}from"./iframe-BsHda9nq.js";var l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O;e((()=>{c(),a(),l=t(),{expect:u}=__STORYBOOK_MODULE_TEST__,d={title:`decorators/withStoryCard`,tags:[`autodocs`,`version:2.2`],parameters:o({description:{component:"The `withStoryCard` decorator adds a card section to should additional information about the story. It is hidden when the story is shown in docs."}}),render:()=>(0,l.jsx)(`p`,{children:`This is the story content`})},f={tags:[`usecase`,`snapshot`],decorators:[i(),i({content:(0,l.jsxs)(`p`,{children:[`When component description is defined and no `,(0,l.jsx)(`code`,{children:"`content`"}),` are provided, the component description will be shown.`]})})],play:async({canvasElement:e})=>{r()||await u(e.querySelectorAll(`section`)).toHaveLength(2)}},p={tags:[`usecase`,`snapshot`],parameters:o({description:{story:`This is story description`}}),decorators:[i(),i({content:(0,l.jsxs)(`p`,{children:[`When story description is provided and no `,(0,l.jsx)(`code`,{children:"`content`"}),` are provided, story description will be shown instead of component description.`]})})],play:async({canvasElement:e})=>{r()||await u(e.querySelectorAll(`section`)).toHaveLength(2)}},m={name:`content: ReactNode`,tags:[`props`],decorators:[i({content:(0,l.jsx)(`p`,{children:`Custom message.`})})],render:()=>(0,l.jsxs)(`p`,{children:[`When providing a custom `,(0,l.jsx)(`code`,{children:"`content`"}),` value, it will be used over component andy story description.`]}),play:async({canvas:e})=>{r()||await u(e.getByText(`Custom message.`)).toBeInTheDocument()}},h={name:`title: ReactNode`,tags:[`props`],parameters:o({description:{story:`The decorator can be used with a title.`}}),decorators:[i({title:`Story Card Title`})],play:async({canvas:e})=>{r()||await u(e.getByText(`Story Card Title`)).toBeInTheDocument()}},g={name:`data-testid: provided`,tags:[`props`],parameters:o({description:{story:"withStoryCard forwards the `data-testid` prop to the card root for testing and automation."}}),decorators:[i({"data-testid":`with-story-card-example`,title:`Card with data-testid`,content:(0,l.jsx)(`p`,{children:`This card has data-testid on the root section for testing.`})})],play:async({canvas:e})=>{r()||await u(e.getByTestId(`with-story-card-example`)).toBeInTheDocument()}},_={name:`status: info`,tags:[`props`,`deprecated`,`version:2.14`,`!version:2.2`],parameters:o({description:{story:`Info status displays with a blue background.`}}),decorators:[i({title:`Deprecated`,appearance:`warn`,content:(0,l.jsxs)(`p`,{children:[`The `,(0,l.jsx)(`code`,{children:`status`}),` prop is deprecated. Use `,(0,l.jsx)(`code`,{children:`appearance: "info"`}),` instead.`]})}),i({title:`Info Card`,status:`info`})],play:async({canvasElement:e})=>{if(r())return;let t=e.querySelectorAll(`section`);await u(t).toHaveLength(2);let n=t[1];await u(n).toHaveClass(`rbsb:bg-sky-100`,`rbsb:dark:bg-sky-900`)}},v={name:`status: warn`,tags:[`props`,`deprecated`,`version:2.14`,`!version:2.2`],parameters:o({description:{story:`Warn status displays with a yellow background.`}}),decorators:[i({title:`Deprecated`,appearance:`warn`,content:(0,l.jsxs)(`p`,{children:[`The `,(0,l.jsx)(`code`,{children:`status`}),` prop is deprecated. Use `,(0,l.jsx)(`code`,{children:`appearance: "warn"`}),` instead.`]})}),i({title:`Warning Card`,status:`warn`})],play:async({canvasElement:e})=>{if(r())return;let t=e.querySelectorAll(`section`);await u(t).toHaveLength(2);let n=t[1];await u(n).toHaveClass(`rbsb:bg-yellow-100`,`rbsb:dark:bg-yellow-900`)}},y={name:`status: error`,tags:[`props`,`deprecated`,`version:2.14`,`!version:2.2`],parameters:o({description:{story:`Error status displays with a red background.`}}),decorators:[i({title:`Deprecated`,appearance:`warn`,content:(0,l.jsxs)(`p`,{children:[`The `,(0,l.jsx)(`code`,{children:`status`}),` prop is deprecated. Use `,(0,l.jsx)(`code`,{children:`appearance: "error"`}),` instead.`]})}),i({title:`Error Card`,status:`error`})],play:async({canvasElement:e})=>{if(r())return;let t=e.querySelectorAll(`section`);await u(t).toHaveLength(2);let n=t[1];await u(n).toHaveClass(`rbsb:bg-red-100`,`rbsb:dark:bg-red-900`)}},b={name:`appearance: error`,tags:[`props`,`version:2.14`,`!version:2.2`],parameters:o({description:{story:`Use for failure states, validation errors, or critical messages that require immediate attention.`}}),decorators:[i({title:`Error Card`,appearance:`error`,content:(0,l.jsxs)(`p`,{children:[`Use `,(0,l.jsx)(`code`,{children:`appearance="error"`}),` when the card conveys a failure or critical message.`]})})],play:async({canvasElement:e})=>{r()||await u(e.querySelector(`section`)).toHaveClass(`rbsb:bg-red-100`,`rbsb:dark:bg-red-900`,`rbsb:border-red-300`,`rbsb:dark:border-red-700`)}},x={name:`appearance: warn`,tags:[`props`,`version:2.14`,`!version:2.2`],parameters:o({description:{story:`Use for cautions, deprecation notices, or non-blocking issues the user should be aware of.`}}),decorators:[i({title:`Warning Card`,appearance:`warn`,content:(0,l.jsxs)(`p`,{children:[`Use `,(0,l.jsx)(`code`,{children:`appearance="warn"`}),` when the card conveys a caution or deprecation.`]})})],play:async({canvasElement:e})=>{r()||await u(e.querySelector(`section`)).toHaveClass(`rbsb:bg-yellow-100`,`rbsb:dark:bg-yellow-900`,`rbsb:border-yellow-300`,`rbsb:dark:border-yellow-700`)}},S={name:`appearance: info`,tags:[`props`,`version:2.14`,`!version:2.2`],parameters:o({description:{story:`Use for general context, tips, or neutral information. Default when neither appearance nor status is set.`}}),decorators:[i({title:`Info Card`,appearance:`info`,content:(0,l.jsxs)(`p`,{children:[`Use `,(0,l.jsx)(`code`,{children:`appearance="info"`}),` for neutral context or tips (default).`]})})],play:async({canvasElement:e})=>{r()||await u(e.querySelector(`section`)).toHaveClass(`rbsb:bg-sky-100`,`rbsb:dark:bg-sky-900`,`rbsb:border-sky-300`,`rbsb:dark:border-sky-700`)}},C={name:`appearance: source`,tags:[`props`,`version:2.14`,`!version:2.2`],parameters:o({description:{story:`Use when embedding code or source snippets so the card blends with the page (e.g. with showDocSource).`}}),decorators:[i({title:`Source Card`,appearance:`source`,content:(0,l.jsxs)(`p`,{children:[`Use `,(0,l.jsx)(`code`,{children:`appearance="source"`}),` for code/source blocks (e.g. with `,(0,l.jsx)(`code`,{children:`showDocSource`}),`).`]})})],play:async({canvasElement:e})=>{r()||await u(e.querySelector(`section`)).toHaveClass(`rbsb:bg-gray-100`,`rbsb:dark:bg-gray-900`,`rbsb:border-gray-300`,`rbsb:dark:border-gray-700`)}},w={name:`appearance: output`,tags:[`props`,`version:2.14`,`!version:2.2`],parameters:o({description:{story:`Use when showing results, success feedback, or generated output.`}}),decorators:[i({title:`Output Card`,appearance:`output`,content:(0,l.jsxs)(`p`,{children:[`Use `,(0,l.jsx)(`code`,{children:`appearance="output"`}),` for results or success feedback.`]})})],play:async({canvasElement:e})=>{r()||await u(e.querySelector(`section`)).toHaveClass(`rbsb:bg-green-100`,`rbsb:dark:bg-green-900`,`rbsb:border-green-300`,`rbsb:dark:border-green-700`)}},T={name:`className: string`,tags:[`props`],parameters:o({description:{story:`The card can be customized with additional className.`}}),decorators:[i({title:`Custom Styled Card`,status:`info`,className:`rbsb:border-2 rbsb:border-blue-500 rbsb:shadow-lg`})],play:async({canvasElement:e})=>{r()||await u(e.querySelector(`section`)).toHaveClass(`rbsb:border-2 rbsb:border-blue-500 rbsb:shadow-lg`)}},E={name:`className: function`,tags:[`props`,`snapshot`],parameters:o({description:{story:"The card can be customized with a className function that receives the `appearance` and `defaultClassName`. The function should return the final className string."}}),decorators:[i({title:`Function-Based Styling`,appearance:`info`,className:({appearance:e,defaultClassName:t})=>n(t,{info:`rbsb:bg-green-200 rbsb:dark:bg-green-800`,warn:`rbsb:bg-amber-300 rbsb:dark:bg-amber-900`,error:`rbsb:bg-rose-400 rbsb:dark:bg-rose-900`,source:``,output:`rbsb:bg-emerald-200 rbsb:dark:bg-emerald-800`}[e??`info`])}),s({source:`className: ({ appearance, defaultClassName }) => string`})]},D={tags:[`edgecase`],parameters:o({description:{component:``}}),decorators:[i()],render:()=>(0,l.jsx)(`p`,{children:"When there are no component or story description, and the `withStoryCard` call does not provide `title` or `children`, it will not render anything."}),play:async({canvasElement:e})=>{r()||await u(e.querySelector(`section`)).not.toBeInTheDocument()}},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
