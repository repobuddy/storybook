import{i as e}from"./preload-helper-Cs4UwXAW.js";import{lt as t}from"./iframe-cIlh6n6x.js";import{n,t as r}from"./dedent-DwYWIg5g.js";import{d as i,g as a,l as o,m as s,t as c}from"./src-BqlPNXF8.js";var l,u,d,f,p,m,h,g,_;e((()=>{n(),c(),l=t(),u=r`// storySort must be a self-contained inline function — Storybook 10+ performs
    ...
    }`,d={title:`parameters/storySort`,tags:[`version:2.30`,`func`],decorators:[s(),a()],parameters:o({docs:{description:{component:r`The \`storySort\` inline function sorts stories by kind (title hierarchy) and then by tag category within the same component. Docs entries (autodocs and MDX) always appear first within a component.
