import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t}from"./chunk-W22LQPXL-B066xLLY.js";import{n,r}from"./iframe-DjofFbqv.js";import{n as i,t as a}from"./dedent-DQaCLeUO.js";function o(e){return`<span style="display: flex; align-items: center; gap: 2px;">
		${e.logo??``}
		${e.title}
                ...
                })`}}},render:()=>(0,s.jsx)(`div`,{dangerouslySetInnerHTML:{__html:o({title:`My Storybook`,logo:`<svg width="16" height="16" viewBox="0 0 16 16"><circle cx="8" cy="8" r="8" fill="#ff4785"/></svg>`})}})}),m=[`SimpleString`,`InHtml`,`WithEmoji`,`WithSvgIcon`],u.input.parameters={...u.input.parameters,docs:{...u.input.parameters?.docs,source:{originalSource:`meta.story({
  parameters: {
    docs: {
      source: {
...
})`,...p.input.parameters?.docs?.source},description:{story:`Example showing how to add an icon to the brand title`,...p.input.parameters?.docs?.description}}}})))()}h();export{d as InHtml,u as SimpleString,f as WithEmoji,p as WithSvgIcon,m as __namedExportsOrder};