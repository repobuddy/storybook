import{n as e}from"./chunk-BneVvdWh.js";import{t}from"./jsx-runtime-6sF1Ejqi.js";import{n,t as r}from"./dedent-TIXhxgm8.js";import{g as i,m as a,t as o}from"./src-RPhsugq1.js";var s,c,l,u;e((()=>{n(),o(),s=t(),c={title:`storybook-addon-tag-badges/perfBadge`,tags:[`var`,`!snapshot`,`version:2.22`],render:()=>(0,s.jsx)(s.Fragment,{})},l={tags:[`perf`],decorators:[a({content:(0,s.jsx)(s.Fragment,{children:(0,s.jsxs)(`p`,{children:[`Story that demonstrates or tests performance. In the sidebar it appears as `,(0,s.jsx)(`code`,{children:`⚡`}),`.`]})})}),i({placement:`before`,source:r`export const YourStory = {
                tags: ['perf'],
