import"./components-DmejZTLj.js";import"./react-K5peCFg_.js";import"./react-dom-CYc0L8kE.js";import{t as e}from"./jsx-runtime-BUC2lftT.js";import{t}from"./dedent-rZS-CQtP.js";import{f as n,m as r}from"./src-CPfUkyQY.js";var i=e(),a={title:`storybook-addon-tag-badges/typeBadge`,tags:[`var`,`!snapshot`,`version:2.15`],render:()=>(0,i.jsx)(i.Fragment,{})},o={tags:[`type`],decorators:[n({content:(0,i.jsxs)(`p`,{children:[`Story that showcases or documents TypeScript types. In the sidebar it appears as `,(0,i.jsx)(`code`,{children:`<T>`}),`.`]})}),r({source:t`export const YourStory = {
                tags: ['type'],
...
}`,...s.parameters?.docs?.source}}};var c=[`TypeBadge`,`DummyStory`];export{s as DummyStory,o as TypeBadge,c as __namedExportsOrder,a as default};