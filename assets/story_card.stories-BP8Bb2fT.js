import{n as e}from"./chunk-DnJy8xQt.js";import{t}from"./jsx-runtime-DC6t-S6Q.js";import{_ as n,b as r,i,m as a}from"./iframe-BsHda9nq.js";var o,s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C;e((()=>{i(),o=t(),{expect:s}=__STORYBOOK_MODULE_TEST__,c={title:`components/StoryCard`,tags:[`new`,`version:2.8`,`autodocs`],component:r,parameters:a({description:{component:["`StoryCard` is a card component that displays information with optional title and appearance styling.","It supports appearance variants: `error`, `warn`, `info` (default), `source`, and `output`.","The component accepts a `title` prop for the heading and `children` for the card body content."].join(`<br/>`)}}),argTypes:{appearance:{control:{type:`select`},options:[`error`,`warn`,`info`,`source`,`output`]},status:{control:{type:`select`},options:[`error`,`warn`,`info`]},title:{control:{type:`text`}},className:{control:{type:`text`}},"data-testid":{control:{type:`text`}}}},l={args:{children:`This is a basic story card with default info status.`}},u={name:`title: provided`,tags:[`props`],parameters:a({description:{story:`StoryCard with a title heading displayed above the content.`}}),args:{title:`Card Title`,children:`This card has a title displayed as a heading.`}},d={name:`status: error`,tags:[`props`,`deprecated`,`version:2.14`,`!version:2.8`],parameters:a({description:{story:'Deprecated: use `appearance: "error"` instead.'}}),args:{status:`error`,title:`Error Card`,children:`This card displays an error status with red background styling.`},decorators:[n({appearance:`warn`})]},f={name:`status: warn`,tags:[`props`,`deprecated`,`version:2.14`,`!version:2.8`],parameters:a({description:{story:'Deprecated: use `appearance: "warn"` instead.'}}),args:{status:`warn`,title:`Warning Card`,children:`This card displays a warning status with yellow background styling.`},decorators:[n({appearance:`warn`})]},p={name:`status: info`,tags:[`props`,`deprecated`,`version:2.14`,`!version:2.8`],parameters:a({description:{story:'Deprecated: use `appearance: "info"` instead.'}}),args:{status:`info`,title:`Info Card`,children:`This card displays an info status with blue background styling.`},decorators:[n({appearance:`warn`})]},m={name:`appearance: error`,tags:[`props`,`version:2.14`,`!version:2.8`],parameters:a({description:{story:`Use for failure states, validation errors, or critical messages that require immediate attention.`}}),args:{appearance:`error`,title:`Error Card`,children:`Use appearance="error" when the card conveys a failure or critical message.`}},h={name:`appearance: warn`,tags:[`props`,`version:2.14`,`!version:2.8`],parameters:a({description:{story:`Use for cautions, deprecation notices, or non-blocking issues the user should be aware of.`}}),args:{appearance:`warn`,title:`Warning Card`,children:`Use appearance="warn" when the card conveys a caution or deprecation.`}},g={name:`appearance: info`,tags:[`props`,`version:2.14`,`!version:2.8`],parameters:a({description:{story:`Use for general context, tips, or neutral information. Default when neither appearance nor status is set.`}}),args:{appearance:`info`,title:`Info Card`,children:`Use appearance="info" for neutral context or tips (default).`}},_={name:`appearance: source`,tags:[`props`,`version:2.14`,`!version:2.8`],parameters:a({description:{story:`Use when embedding code or source snippets so the card blends with the page (e.g. with showDocSource).`}}),args:{appearance:`source`,title:`Source Card`,children:`Use appearance="source" for code/source blocks that should blend in.`}},v={name:`appearance: output`,tags:[`props`,`version:2.14`,`!version:2.8`],parameters:a({description:{story:`Use when showing results, success feedback, or generated output.`}}),args:{appearance:`output`,title:`Output Card`,children:`Use appearance="output" for results or success feedback.`}},y={name:`children: complex content`,tags:[`props`],parameters:a({description:{story:`StoryCard can contain complex React content, not just plain text.`}}),render:()=>(0,o.jsx)(r,{title:`Complex Content Example`,children:(0,o.jsxs)(`div`,{className:`rbsb:flex rbsb:flex-col rbsb:gap-2`,children:[(0,o.jsx)(`p`,{children:`This card contains multiple elements:`}),(0,o.jsxs)(`ul`,{className:`rbsb:list-disc rbsb:list-inside rbsb:ml-4`,children:[(0,o.jsx)(`li`,{children:`List item one`}),(0,o.jsx)(`li`,{children:`List item two`}),(0,o.jsx)(`li`,{children:`List item three`})]}),(0,o.jsx)(`button`,{type:`button`,className:`rbsb:bg-sky-500 rbsb:text-white rbsb:rounded rbsb:px-4 rbsb:py-2 rbsb:self-start`,children:`Action Button`})]})})},b={name:`className: custom`,tags:[`props`],parameters:a({description:{story:`StoryCard accepts a custom className prop to override or extend default styles.`}}),args:{title:`Custom Styled Card`,className:`rbsb:border-2 rbsb:border-sky-500`,children:`This card has custom border styling applied via className.`}},x={name:`className: function`,tags:[`props`],parameters:a({description:{story:`StoryCard accepts a function for className that receives the card state (including appearance) and default className.`}}),render:()=>(0,o.jsx)(r,{title:`Function-based className`,appearance:`warn`,className:({appearance:e,defaultClassName:t})=>`${t} rbsb:border-2 ${e===`warn`?`rbsb:border-yellow-500`:`rbsb:border-gray-500`} rbsb:shadow-lg`,children:`This card uses a function to compute className based on the card state.`})},S={name:`data-testid`,tags:[`props`,`unit`],parameters:a({description:{story:"StoryCard forwards the `data-testid` prop to the root section for testing and automation."}}),args:{"data-testid":`story-card-example`,title:`Card with data-testid`,children:`This card has data-testid="story-card-example" on the root section for testing.`},play:async({canvas:e})=>{await s(e.getByTestId(`story-card-example`)).toBeInTheDocument()}},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  args: {
