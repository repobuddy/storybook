import{j as a}from"./jsx-runtime-D_zvdyIk.js";import{d as o}from"./dedent-DVFkJXTl.js";import{d as n}from"./define_docs_param-lmgaBKCF.js";import{s as g}from"./show_doc_source-CWgnZoeJ.js";function t(M){return{test:M}}const R={title:"Parameters/defineTestParam",tags:["new","version:1.0.0"],parameters:{docs:{description:{component:"Helper function to define test parameters for Storybook stories"}}},decorators:[g()],render:()=>a.jsx(a.Fragment,{})},e={parameters:{...t({clearMocks:!0,mockReset:!0,restoreMocks:!0}),...n({source:{code:o`defineTestParam({
                    clearMocks: true,
                    mockReset: true,
                    restoreMocks: true
