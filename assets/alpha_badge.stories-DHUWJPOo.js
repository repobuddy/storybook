import{j as a}from"./iframe-BJchrtiz.js";import{d as o}from"./dedent-D4JfOF0A.js";import{s as e}from"./show_source-NtLBjQ65.js";import{w as t}from"./with_story_card-Cef5k-cI.js";import"./preload-helper-PPVm8Dsz.js";const i={title:"storybook-addon-tag-badges/alphaBadge",tags:["var","!snapshot","version:2.19"],render:()=>a.jsx(a.Fragment,{})},r={tags:["alpha"],decorators:[t({content:a.jsxs("p",{children:["Mark that a component or prop is in alpha (experimental). In the sidebar it appears as ",a.jsx("code",{children:"🔴"}),"."]})}),e({source:o`export const YourStory = {
                tags: ['alpha'],
