import{j as r}from"./iframe-7Yb0LowJ.js";import{s as m}from"./show_doc_source-Ca9dZB63.js";const p=({text:l="Hello World"})=>r.jsx("div",{className:"p-4 bg-gray-100 dark:bg-gray-500 rounded",children:l}),g={title:"decorators/showDocSource",component:p,tags:["autodocs"],parameters:{layout:"padded"}},o={parameters:{docs:{source:{code:'<DemoComponent text="Hello World" />'}}},args:{text:"Hello World"},decorators:[m()]},e={name:"Without Source Code",decorators:[m()],parameters:{docs:{source:{code:'<DemoComponent text="Hello World" />'}}},render:()=>r.jsx(r.Fragment,{})};var s,t,a;o.parameters={...o.parameters,docs:{...(s=o.parameters)==null?void 0:s.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
