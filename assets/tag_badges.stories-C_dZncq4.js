import{j as e,s as h,d as v}from"./iframe-CoPqPLz4.js";import{d as y}from"./dedent-C8rexWvS.js";import"./preload-helper-PPVm8Dsz.js";const w={title:"storybook-addon-tag-badges/tagBadges"},r={tags:["editor"],render:()=>e.jsxs("div",{children:[e.jsx("div",{children:"Story with live editor"}),e.jsx("code",{children:"tags: ['editor']"})]})},o={tags:["new"],render:()=>e.jsxs("div",{children:[e.jsx("div",{children:"Recently added components or props/features"}),e.jsx("code",{children:"tags: ['new']"})]})},t={tags:["beta"],render:()=>e.jsxs("div",{children:[e.jsx("div",{children:"Warn that a component or prop is not stable yet"}),e.jsx("code",{children:"tags: ['beta']"})]})},d={tags:["deprecated"],render:()=>e.jsxs("div",{children:[e.jsx("div",{children:"Components or props that should be avoided in new code"}),e.jsx("code",{children:"tags: ['deprecated']"})]})},s={tags:["outdated"],render:()=>e.jsxs("div",{children:[e.jsx("div",{children:"Components with design changes that weren't yet implemented, which can incur extra development costs to your users"}),e.jsx("code",{children:"tags: ['outdated']"})]})},n={tags:["danger"],render:()=>e.jsxs("div",{children:[e.jsx("div",{children:"Components that require particular attention when configuring them (e.g. for with security concerns)"}),e.jsx("code",{children:"tags: ['danger']"})]})},a={tags:["todo"],render:()=>e.jsxs("div",{children:[e.jsx("div",{children:"Todo story"}),e.jsx("code",{children:"tags: ['todo']"})]})},i={tags:["code-only"],render:()=>e.jsxs("div",{children:[e.jsx("div",{children:"Components that only exist in code, and not in design"}),e.jsx("code",{children:"tags: ['code-only']"})]})},c={tags:["internal"],parameters:v({source:{code:y`
            ...
            `}}),decorators:[h()],render:()=>e.jsx(e.Fragment,{})},g={tags:["snapshot","!test"],render:()=>e.jsxs("div",{children:[e.jsx("div",{children:"Story with snapshot"}),e.jsx("code",{children:"tags: ['snapshot']"})]})},p={tags:["keyboard"],render:()=>e.jsxs("div",{children:[e.jsx("div",{children:"Story with keyboard interactions"}),e.jsx("code",{children:"tags: ['keyboard']"})]})},u={tags:["unit"],render:()=>e.jsxs("div",{children:[e.jsx("div",{children:"Unit test story"}),e.jsx("code",{children:"tags: ['unit']"})]})},l={tags:["integration"],render:()=>e.jsxs("div",{children:[e.jsx("div",{children:"Integration test story"}),e.jsx("code",{children:"tags: ['integration']"})]})},m={tags:["version:1.0"],render:()=>e.jsxs("div",{children:[e.jsx("div",{children:"Version tag is used to indicate when the component/feature/property becomes available."}),e.jsx("code",{children:"tags: ['version:1.0']"})]})};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  tags: ['editor'],
  render: () => <div>
...
}`,...m.parameters?.docs?.source}}};const B=["EditorBadge","NewBadge","BetaBadge","DeprecatedBadge","OutdatedBadge","DangerousBadge","TodoBadge","CodeOnlyBadge","InternalBadge","SnapshotBadge","KeyboardBadge","UnitTestBadge","IntegrationTestBadge","VersionBadge"];export{t as BetaBadge,i as CodeOnlyBadge,n as DangerousBadge,d as DeprecatedBadge,r as EditorBadge,l as IntegrationTestBadge,c as InternalBadge,p as KeyboardBadge,o as NewBadge,s as OutdatedBadge,g as SnapshotBadge,a as TodoBadge,u as UnitTestBadge,m as VersionBadge,B as __namedExportsOrder,w as default};
