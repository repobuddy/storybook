import{j as a}from"./iframe-B4Fl_E7C.js";import{d as o}from"./dedent-BuYMbVyj.js";import{s as e}from"./show_source-D_hPi-DF.js";import{w as t}from"./with_story_card-4VxCvVhT.js";import"./preload-helper-PPVm8Dsz.js";const i={title:"storybook-addon-tag-badges/alphaBadge",tags:["var","!snapshot","version:2.19"],render:()=>a.jsx(a.Fragment,{})},r={tags:["alpha"],decorators:[t({content:a.jsxs("p",{children:["Mark that a component or prop is in alpha (experimental). In the sidebar it appears as ",a.jsx("code",{children:"🔴"}),"."]})}),e({source:o`export const YourStory = {
                tags: ['alpha'],
