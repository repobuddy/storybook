import{j as e,s as n,d as t,t as m}from"./iframe-BAM9uuYf.js";import{d}from"./dedent-C8rexWvS.js";import"./preload-helper-PPVm8Dsz.js";const l=({text:c="Hello World"})=>e.jsx("div",{className:"p-4 bg-gray-100 dark:bg-gray-500 rounded",children:c}),g={title:"decorators/showDocSource",tags:["autodocs"],parameters:{layout:"padded"}},o={parameters:{docs:{source:{code:'() => <DemoComponent text="Hello World" />'}}},decorators:[n()],render:()=>e.jsx(l,{text:"Hello World"})},r={parameters:{docs:{source:{code:'() => <DemoComponent text="Hello World" />'}}},decorators:[n()],render:()=>e.jsx(e.Fragment,{})},s={parameters:t({source:{code:d`
                <div>Hello, World!</div>
