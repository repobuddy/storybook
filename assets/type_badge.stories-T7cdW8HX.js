import{n as e}from"./chunk-BneVvdWh.js";import{t}from"./jsx-runtime-6sF1Ejqi.js";import{n,t as r}from"./dedent-TIXhxgm8.js";import{g as i,m as a,t as o}from"./src-XpyBqwIv.js";var s,c,l,u,d;e((()=>{n(),o(),s=t(),c={title:`storybook-addon-tag-badges/typeBadge`,tags:[`var`,`!snapshot`,`version:2.15`],render:()=>(0,s.jsx)(s.Fragment,{})},l={tags:[`type`],decorators:[a({content:(0,s.jsxs)(`p`,{children:[`Story that showcases or documents TypeScript types. In the sidebar it appears as `,(0,s.jsx)(`code`,{children:`<T>`}),`.`]})}),i({source:r`export const YourStory = {
                tags: ['type'],
