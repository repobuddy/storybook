import"./components-DmejZTLj.js";import"./react-K5peCFg_.js";import"./react-dom-CYc0L8kE.js";import{t as e}from"./jsx-runtime-BUC2lftT.js";import{t}from"./dedent-rZS-CQtP.js";import{f as n,m as r}from"./src-CPfUkyQY.js";var i=e(),a={title:`storybook-addon-tag-badges/functionBadge`,tags:[`var`,`!snapshot`,`version:2.16`],render:()=>(0,i.jsx)(i.Fragment,{})},o={tags:[`func`],decorators:[n({content:(0,i.jsxs)(`p`,{children:[`Story that showcases or documents functions. In the sidebar it appears as `,(0,i.jsx)(`code`,{children:`ƒ(x)`}),`.`]})}),r({source:t`export const YourStory = {
                tags: ['func'],
...
}`,...s.parameters?.docs?.source}}};var c=[`FunctionBadge`,`DummyStory`];export{s as DummyStory,o as FunctionBadge,c as __namedExportsOrder,a as default};