import{j as c}from"./iframe-CVqhhPMf.js";import{d as t}from"./dedent-BuYMbVyj.js";import"./show_source-CVaJueDf.js";import{s as n}from"./show_doc_source-C2YDxLi5.js";import{d as s}from"./define_docs_param-lmgaBKCF.js";import"./preload-helper-PPVm8Dsz.js";const y={title:"Parameters/defineDocsParam",tags:["autodocs","func","!snapshot","new","version:1.0"],parameters:s({description:{component:"`docs.description.component` can be used to describe the component in meta. It has no effect on the stories."}}),decorators:[n()],render:()=>c.jsx(c.Fragment,{})},e={parameters:s({source:{code:t`
            /**
...
}`,...o.parameters?.docs?.source},description:{story:"`docs.source.code` can be used to define the source code of the story.",...o.parameters?.docs?.description}}};const f=["JSDoc","WithStoryDescription","SourceCode"];export{e as JSDoc,o as SourceCode,r as WithStoryDescription,f as __namedExportsOrder,y as default};
