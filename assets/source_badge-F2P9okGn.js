import{j as e,M as n}from"./iframe-D7G3ENHL.js";import{useMDXComponents as r}from"./index-BG6BcsMe.js";import"./preload-helper-PPVm8Dsz.js";function t(s){const o={code:"code",h1:"h1",h2:"h2",p:"p",pre:"pre",strong:"strong",...r(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n,{title:"storybook-addon-tag-badges/sourceBadge"}),`
...
`,e.jsxs(o.p,{children:["Add the ",e.jsx(o.code,{children:"source"})," tag to your story and use the ",e.jsx(o.code,{children:"showSource()"})," decorator so the story's source is visible in the docs."]}),`
`,e.jsx(o.pre,{children:e.jsx(o.code,{className:"language-tsx",children:`import { showSource } from '#repobuddy/storybook'
