import{i as e}from"./preload-helper-Cs4UwXAW.js";import{lt as t}from"./iframe-cIlh6n6x.js";import{n,t as r}from"./dedent-DwYWIg5g.js";import{g as i,m as a,t as o}from"./src-BqlPNXF8.js";var s,c,l,u,d;e((()=>{n(),o(),s=t(),c={title:`storybook-addon-tag-badges/functionBadge`,tags:[`var`,`!snapshot`,`version:2.16`],render:()=>(0,s.jsx)(s.Fragment,{})},l={tags:[`func`],decorators:[a({content:(0,s.jsxs)(`p`,{children:[`Story that showcases or documents functions. In the sidebar it appears as `,(0,s.jsx)(`code`,{children:`ƒ(x)`}),`.`]})}),i({source:r`export const YourStory = {
                tags: ['func'],
