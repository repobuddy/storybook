import{j as e,M as d}from"./iframe-B9TY5VBC.js";import{useMDXComponents as r}from"./index-B3dN6pKV.js";import"./preload-helper-PPVm8Dsz.js";function o(n){const t={code:"code",h1:"h1",h2:"h2",p:"p",pre:"pre",strong:"strong",...r(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(d,{title:"storybook-addon-tag-badges/deprecatedBadge"}),`
`,e.jsx(t.h1,{id:"deprecated-badge",children:"Deprecated badge"}),`
`,e.jsxs(t.p,{children:["Use the ",e.jsx(t.strong,{children:"deprecated"}),' badge for components or props that should be avoided in new code. The badge displays 🪦 with a "Deprecated" tooltip.']}),`
