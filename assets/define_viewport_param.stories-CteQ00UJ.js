import{n as e}from"./chunk-DnJy8xQt.js";import{t}from"./jsx-runtime-DC6t-S6Q.js";import{i as n,l as r,m as i,v as a}from"./iframe-BsHda9nq.js";import{n as o,t as s}from"./dedent-DU6uki2e.js";var c,l,u,d,f,p,m;e((()=>{o(),n(),c=t(),l={title:`Parameters/defineViewportParam`,tags:[`autodocs`,`!snapshot`,`func`,`new`,`version:1.0`],decorators:[a()],render:()=>(0,c.jsx)(c.Fragment,{})},u={parameters:{...r({defaultViewport:`mobile1`,viewports:{mobile1:{name:`Mobile`,styles:{width:`320px`,height:`568px`},type:`mobile`},tablet1:{name:`Tablet`,styles:{width:`768px`,height:`1024px`},type:`tablet`}}}),...i({source:{code:s`defineViewportParam({
                ...
                })`}})}},d={parameters:{...r({defaultOrientation:`landscape`}),...i({source:{code:s`defineViewportParam({
                    defaultOrientation: 'landscape'
                })`}})}},f={parameters:{...r({disable:!0}),...i({source:{code:s`defineViewportParam({
                    disable: true
                })`}})}},p={parameters:{...r({defaultViewport:`tablet1`}),...i({source:{code:s`defineViewportParam({
