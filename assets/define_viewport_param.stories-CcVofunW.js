import{j as s,d as o}from"./iframe-7Yb0LowJ.js";import{d as n}from"./dedent-DVFkJXTl.js";import{s as T}from"./show_doc_source-Ca9dZB63.js";function i(M){return{viewport:M}}const B={title:"Parameters/defineViewportParam",tags:["new","version:1.0","autodocs"],decorators:[T()],render:()=>s.jsx(s.Fragment,{})},e={parameters:{...i({defaultViewport:"mobile1",viewports:{mobile1:{name:"Mobile",styles:{width:"320px",height:"568px"},type:"mobile"},tablet1:{name:"Tablet",styles:{width:"768px",height:"1024px"},type:"tablet"}}}),...o({source:{code:n`defineViewportParam({
