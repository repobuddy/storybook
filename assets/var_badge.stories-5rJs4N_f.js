import{n as e}from"./chunk-BneVvdWh.js";import{t}from"./jsx-runtime-6sF1Ejqi.js";import{n,t as r}from"./dedent-C7gAFWmM.js";import{g as i,m as a,t as o}from"./src-xVZ3M_hi.js";var s,c,l,u,d;e((()=>{n(),o(),s=t(),c={title:`storybook-addon-tag-badges/varBadge`,tags:[`var`,`!snapshot`,`version:2.16`],render:()=>(0,s.jsx)(s.Fragment,{})},l={name:`Variable Badge`,tags:[`var`],decorators:[a({content:(0,s.jsxs)(`p`,{children:[`Story that describes values and variables. In the sidebar it appears as `,(0,s.jsx)(`code`,{children:`var`}),`.`]})}),i({source:r`export default {
                tags: ['var'],
                // ...
            } satisfies Meta
